...
cantusV = \relative c' {
    ...
    a2 f ~ | f4 e d2 c d | a d c4 d e f | g2 f1 e2 | f1 r1 | r2 a f g |
        a2. bf4 c2 d | a c1 \ficta b2 \unficta | c1 c2 a ~ | 
        a g a d, e g1 e2 | f d c f ~ | f4 g a bf
    ...
    g1 \ficta fs2 \unficta | g bf a g | f e d f | e1 r2 d | f2. g4 a1 | 
        g2 f1 e2 | f c f2. a4 | g2 f r2 d ~ | d \ficta cs \unficta d f | 
        e d c bf | a a' bf g | a bf a g ~ | g f d2. e4 | 

    \repeat volta 2 {
        f2 e a1 | g2 a1 d,2 | f e2. f4 g2 | f e a1 | g2 a1 d,2 | f e1 d2 | 
        e g d f | c1 r1 | r1 r2 g' | e f d2. e4 | f2 e2. d4 e f | g2 d g c, |
        f2. g4 a1 | r2 c a bf | g2. a4 bf2 a ~ | a4 g a bf c2 g | 
        bf a2. g4 e f | g e a1 g2 | 
    }
    \alternative { { a2 f d2. e4 } { a4 g f e f2. e4 } }
% repeated section
% f2 e a1 | g2 a1 d,2 | f e2. f4 g2 | f e a1 | g2 a1 d,2 | f e1 d2 | e g d f | c1 r1 | r1 r2 g' | e f d2. e4 | f2 e2. d4 e f | g2 d g c, | f2. g4 a1 | r2 c a bf | g2. a4 bf2 a ~ | a4 g a bf c2 g | bf a2. g4 e f | g e a1 g2 | 

    c2 f2. e4 e2 | d f e2. f4 | g2 f d1 | cs\longa*1/2
    \bar "|."
}
...
tenorV = \relative c' {
    ...
    a1 | r2 f g a | d, d'2. c4 a2 | b d1 \ficta cs2 \unficta | d1 r2 f ~ | 
        f g f2. e4 | d2 f e1 | d2 f2. e4 d2 | c bf a2. g4 | f2 e f g | 
        a4 bf c d e2 a, | c2. bf4 a1 | R\breve | r2 a 
    ...
    r2 a'1 bf2 | a f g a | d,1 r1 | r2 d e f ~ | f4 g a bf c2 f, ~ |
        f e f a | g f c'1 | c a | a a | r2 d1 c2 | bf a2. bf4 c2 | 
        d c2. bf4 g2 | bf a1 g2 | f e2. f4 g2 | a e

    f2. e4 | f2 e r2 e | f e f d | e e' f2. e4 | d1 r2 d | f2. e4 d2 c |
        f g e2. f4 | g2 f1 e2 | f1 e | f r2 d ~ | d c2 bf1 ~ | 
        bf2 a2 bf2 d ~ | d c2 bf4 c d2 | g,1 a | g r2 d' ~ | d c2 

    bf2 a2 ~ | a4 bf4 c2 d bf | a1 r2 f' | e d c bf | a1 a | r2 bf a g |
        f e d1 | R\breve | r1 d'1 | c2 d1 g,2 | bf a1 g2 | 

    \repeat volta 2 {
        a c1 f,2 | c'2. a4 c2 bf | a2. b4 cs2 d ~ | d \ficta cs2 d a | \unficta 
        c1 r1 | r2 c a bf | g2. a4 bf2 a2 ~ | a4 g4 a bf c2 g | bf a2. g4 e f |
        g e a1 g2 | a c g c ~ | c bf2 c a2 ~ | a4 f4 bf2 a f' ~ | f e2 f d |
        e1 r1 | f e | d c1 ~ | c bf1 |
    } 
    \alternative { { a2 a1 g2 } { a1 r2 a ~ } }
% repeated section
% a g a c ~ | c f, c'2. a4 | c2 bf a2. b4 | cs2 d1 \ficta cs!2 \unficta | d a c1 | r1 r2 c | a bf g2. a4 | bf2 a2. g4 a bf | c2 g bf a ~ | a4 g e f g e a2 ~ | a g a c | g c1 bf2 | c a2. f4 bf2 | a f'1 e2 | f d e1 | r1 f | e d | c\breve | bf1 a | 

     a4 g4 a bf c2 g | bf a1 g2 | e a1 g2 | a\longa*1/2
...
bassusV = \relative c {
    ...
    f2 ef | d2. c4 bf1 | 
    \repeat volta 2 {
        a1 r | R\breve | r2 a'1 g2 | a1 d,2 f | e f d g | 
        a2. g4 f2 g | c,4 d e f g2 d | f1 c | d a2 c ~ | c a bf1 | 
        a2. bf4 c2. d4 | e f g2 e f | d2. e4 f2 d4 e | f g a2 f g | 
        c,4 d e f g2 f | d1 a2 c | bf4 c d e f2 a | e f d e | 
    }
    \alternative { { f4 e d c bf1 } { f'2 d2. c4 d e } }

% Repeated section
% a r1 | R\breve | r2 a'1 g2 | a1 d,2 f | e f d g | a2. g4 f2 g | c,4 d e f g2 d | f1 c | d a2 c ~ | c a bf1 | a2. bf4 c2. d4 | e f g2 e f | d2. e4 f2 d4 e | f g a2 f g | c,4 d e f g2 f | d1 a2 c | bf4 c d e f2 a | e2 f d e | 

 f2 d a c | bf d a c ~ | c d bf1 | a\longa*1/2
