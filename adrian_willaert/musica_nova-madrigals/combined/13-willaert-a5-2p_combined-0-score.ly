...
\book {
    \bookOutputName "13-quando_fra_l_altre_donne-2p_combined"
    ...
    \score {
        <<
            \new ChoirStaff = choirStaff \with {
                ...
                \new Voice <<
                    \set Staff.instrumentName = #"Cantus"
                    \incipit \cantusXIIIIincipitVoice
                    \clef treble
                    \global
                    \cantusXIIII
                >>
                \addlyrics { \cantusLyricsXIIII }
                \new Voice <<
                    \set Staff.instrumentName = #"Altus"
                    \incipit \altusXIIIIincipitVoice
                    \clef "treble_8"
                    \global
                    \altusXIIII
                >>
                \addlyrics { \altusLyricsXIIII }
                \new Voice <<
                    \set Staff.instrumentName = #"Tenor"
                    \incipit \tenorXIIIIincipitVoice
                    \clef "treble_8"
                    \global
                    \tenorXIIII
                >>
                \addlyrics { \tenorLyricsXIIII }
                \new Voice <<
                    \set Staff.instrumentName = #"Quintus"
                    \incipit \quintusXIIIIincipitVoice
                    \clef "treble_8"
                    \global
                    \quintusXIIII
                >>
                \addlyrics { \quintusLyricsXIIII }
                \new Voice <<
                    \set Staff.instrumentName = #"Bassus"
                    \incipit \bassusXIIIIincipitVoice
                    \clef "bass"
                    \global
                    \bassusXIIII
                >>
                \addlyrics { \bassusLyricsXIIII }
            >>
        >>
        \midi {
            \context {
