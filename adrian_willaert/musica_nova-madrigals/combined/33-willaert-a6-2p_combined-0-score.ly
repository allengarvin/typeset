...
\book {
    ...
    \score {
            ...
            \new ChoirStaff = choirStaff <<
                \new Voice <<
                    \set Staff.instrumentName = #"Cantus"
                    \incipit \cantusXXXIIIIincipitVoice
                    \clef treble
                    \global
                    \cantusXXXIIII
                >>
                \addlyrics { \cantusLyricsXXXIIII }
                \new Voice <<
                    \set Staff.instrumentName = #"Quintus"
                    \incipit \quintusXXXIIIIincipitVoice
                    \clef "treble"
                    \global
                    \quintusXXXIIII
                >>
                \addlyrics { \quintusLyricsXXXIIII }
                \new Voice <<
                    \set Staff.instrumentName = #"Altus"
                    \incipit \altusXXXIIIIincipitVoice
                    \clef "treble_8"
                    \global
                    \altusXXXIIII
                >>
                \addlyrics { \altusLyricsXXXIIII }
                \new Voice <<
                    \set Staff.instrumentName = #"Sesta"
                    \incipit \sestaXXXIIIIincipitVoice
                    \clef "treble_8"
                    \global
                    \sestaXXXIIII
                >>
                \addlyrics { \sestaLyricsXXXIIII }
                \new Voice <<
                    \set Staff.instrumentName = #"Tenor"
                    \incipit \tenorXXXIIIIincipitVoice
                    \clef "treble_8"
                    \global
                    \tenorXXXIIII
                >>
                \addlyrics { \tenorLyricsXXXIIII }
                \new Voice <<
                    \set Staff.instrumentName = #"Bassus"
                    \incipit \bassusXXXIIIIincipitVoice
                    \clef "bass"
                    \global
                    \bassusXXXIIII
                >>
                \addlyrics { \bassusLyricsXXXIIII }
            >>
        >>
        \include "../include/vocal-layout-score-barring.ly"
        \header {
