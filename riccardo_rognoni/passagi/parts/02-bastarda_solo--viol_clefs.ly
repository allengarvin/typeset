...
bastardaII = \relative c' {
    ...
    a2 c a4 c2 d4 | e2 f e4 a, \clef bass a,2 | 
        e'4 e,2 e'4 \clef alto f2 g4 a8[ b] | c4 d e f g e,8[ f] g[ a] b4 | 

    c4 c,8[ d] e[ f] g4 a e' c d | e a,4. gs8[ gs fs16 gs] a2 a, |
        e' e' f8[ e f g] f4 e | d2 g, a8[ g a bf] a4 g |
        fs \ficta e8[ fs] g4 d'\unficta

    e4 c d d, | \clef bass e e, a2 a' g4 c | f, g a c \clef alto d4 e a, b |
        c f e c' b g a d, | c a g f8[ e] d4 c8[ b] a4 a' |
    ...
    \invisibleTime\time 2/2 s1*0\raisedTwoTwoTime
     ...
     \invisibleTime\time 4/2
                                                         ...
                                                         % vv e2 to e4
    a4 e' f2 e e, | f a c2 b4 b' | c2 b4 \clef bass e,, f2 e4 a,|
        d2 c4 \clef alto e' f a g e | f d c8[ b a g] f8[ e] d4 e c' ~ |
        c4 d4 e c' 

      %  vvv b8 corrected to b16
    b4. b16[ c] c4 e, | f8[ g a g16 f] e4 \clef bass e, f8[ g f e] d[ c] d4 |
        e2 e, a4 a'8[ b] c2 | b8[ g c b] a[ g] a4 \clef alto g4 g' fs g |
        e2 d4 g, 

    fs4 g e2 | \ficta d8[ e f g] a[ b c d]\unficta e2 e, | \clef bass 
        a4 a, d d' c8[ e d c] b[ a] b4 | a4 e a,8[ b c d] e1 |
        e,\longa*1/2
