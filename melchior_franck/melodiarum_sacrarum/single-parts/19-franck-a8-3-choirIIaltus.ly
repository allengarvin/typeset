...
\header {
    ...
    subtitle = ""
    subsubtitle = ""
    instrument = "Factum est silentium:  (choirIIaltus)"
    ...
    partname = "Choir II Altus (part 5 of 8)"
    instrument = "Factum est silentium:  (choirIIaltus)"
...
\book {
    ...
    \bookOutputSuffix "--5-choir-2-altus--tr8_clef"
    \include "../include/paper-1-part.ly"
    \score {
        \new Voice << 
            \clef "treble_8"
...
\book {
    \bookOutputName "19-franck--factum_est_silentium-"
    \bookOutputSuffix "--5-choir-2-altus--tr_clef"
    \include "../include/paper-1-part.ly"
    \score {
        \new Voice << 
            \clef "treble"
...
\book {
    \bookOutputName "19-franck--factum_est_silentium-"
    \bookOutputSuffix "--5-choir-2-altus--al_clef"
    \include "../include/paper-1-part.ly"
    \score {
        \new Voice << 
            \clef "alto"
