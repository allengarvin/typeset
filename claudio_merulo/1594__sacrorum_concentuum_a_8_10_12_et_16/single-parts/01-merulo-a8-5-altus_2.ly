...
\header {
    ...
    subtitle = ""
    subsubtitle = ""
    instrument = "Ave gratia plena:  (altus II)"
    ...
    partname = "Altus II (Choir II (low), part 2 of 4)"
    instrument = "Ave gratia plena:  (altus II)"
...
\book {
    ...
    \bookOutputSuffix "--6-choir_2-altus_2--tr8_clef"
    \include "../include/paper-1-part.ly"
    \score {
        \new Voice << 
            \clef "treble_8"
...
\book {
    \bookOutputName "01-merulo--ave_gratia_plena-"
    \bookOutputSuffix "--6-choir_2-altus_2--al_clef"
    \include "../include/paper-1-part.ly"
    \score {
        \new Voice << 
            \clef "alto"
