...
\header {
    ...
    subtitle = ""
    subsubtitle = ""
    instrument = "Ave gratia plena:  (tenor II)"
    ...
    partname = "Tenor II (Choir II (low), part 3 of 4)"
    instrument = "Ave gratia plena:  (tenor II)"
...
\book {
    ...
    \bookOutputSuffix "--7-choir_2-tenor_2--tr8_clef"
    \include "../include/paper-1-part.ly"
    \score {
        \new Voice << 
            \clef "treble_8"
...
\book {
    \bookOutputName "01-merulo--ave_gratia_plena-"
    \bookOutputSuffix "--7-choir_2-tenor_2--al_clef"
    \include "../include/paper-1-part.ly"
    \score {
        \new Voice << 
            \clef "alto"
