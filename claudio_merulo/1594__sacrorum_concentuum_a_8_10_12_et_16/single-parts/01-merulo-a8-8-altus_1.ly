...
\header {
    ...
    subtitle = ""
    subsubtitle = ""
    instrument = "Ave gratia plena:  (altus I)"
    ...
    partname = "Altus I (Choir I (high), part 2 of 4)"
    instrument = "Ave gratia plena:  (altus I)"
...
\book {
    ...
    \bookOutputSuffix "--2-choir_1-altus_1--tr_clef"
    \include "../include/paper-1-part.ly"
    \score {
        \new Voice << 
            \clef "treble"
...
\book {
    \bookOutputName "01-merulo--ave_gratia_plena-"
    \bookOutputSuffix "--2-choir_1-altus_1--al_clef"
    \include "../include/paper-1-part.ly"
    \score {
        \new Voice << 
            \clef "alto"
