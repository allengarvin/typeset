...
\header {
    lastupdated = "2025-choir_2-04-25"
    originallyset = "2025-choir_2-04-25"
    ...
    subtitle = ""
    subsubtitle = ""
    instrument = "Ave gratia plena:  (cantus II)"
    ...
    partname = "Cantus II (Choir II (low), part 1 of 4)"
    instrument = "Ave gratia plena:  (cantus II)"
...
\book {
    ...
    \bookOutputSuffix "--5-choir_2-cantus_2--tr8_clef"
    \include "../include/paper-1-part.ly"
    \score {
        \new Voice << 
            \clef "treble_8"
...
\book {
    \bookOutputName "01-merulo--ave_gratia_plena-"
    \bookOutputSuffix "--5-choir_2-cantus_2--al_clef"
    \include "../include/paper-1-part.ly"
    \score {
        \new Voice << 
            \clef "alto"
