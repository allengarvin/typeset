...
% Invocation: /usr/local/bin/generate-single.py -t "Deh, avesse Amor così" -l italian -v -l italian -p "ottava rima" -m 80 -s 17 13-merulo-a3-0-score.ly canto:t tenore:t basso:8a
...
\header {
    ...
    subtitle = ""
    subsubtitle = ""
    instrument = "Deh, avesse Amor così:  (tenore)"
