...
cantoI = \relative c'' {
    ...
    r1 d ~ | d2 d d d ~ | d d ef c | e e d1 | d2 f2. f4 c2 | ef d d1 | 
        d2 bf c ef | d1 d | g f |

    r2 f1 e2 | d e2.( d4 d2 ~ | d4 c8[ bf] c2) d1 ~ | d r1 | r1 r2 d | f1. c2 |
        ef ef ef1 | d2 d c2. d4 | ef c d2 d r4 d | 

    f4 f e e d4.( e8 f2) | e r4 g f f e e | f4.( e8 d2. c8[ bf] c2) | 
...
%     O di che gra -- to o -- dor i bei giacinti 
%     Empiono~il lido ameno che bagna 
%     Parma Tebro Adria e Tirreno
%     E mentre son di pinti
%     Del nom' Augusto vero
%     Dan gloria a l'hemispero
%     Felici piante à voi
%     Non manch'amico sole
%     Che com'or siete sole
%     splendor de' raggi suoi
%     Così v'adorin poi
%     D'arti d'armi e d'honor l'industri scole
}
...
altoI = \relative c'' {
    ...
    r2 f ~ | f4( g a2. bf4 c2) | bf1. g2 | a1 a | r2 bf bf a | a4 a g2 f1 |
        r2 a a a | c c b1 | bf2 bf a2. bf4 | g g fs2 
    ...
    g2 r4 a a a bf2 | g c a1 | r1 r4 a2 bf4 ~ | bf bf4 c4.( bf8 a4) g a2 |
        bf1 r1 | r2 r4 a a a g2 | g r4 a a a bf2 ~ | bf4 a g2.( f8[ e] f2) |
    ...
    g2 g r2 r4 a ~ | a a bf bf g g fs4.( g8 | a2) g r1 | g2. g4 a a f f |
        g4.( f8 ef2 c4) f2 f4 | g2 g g4.( a8 bf2) | a g2.( f8[ e] f2) | 
        g\longa*1/2
...
tenoreI = \relative c' {
    ...
    r4 c2 c4 d d | bf bf c2.( d8 ef2) | d1 r4 g2 g4 | a a fs fs g4.( ef8 e2) |
        a, b c4 c2 a4 | bf bf g2 g r1 | bf2. bf4 c2 d | d bf a1 | g\longa*1/2
    \bar "|."
}
...
bassoI = \relative c' {
    ...
    a'2 g r4 d a'2 | d, f4 g a1 | d, r1 | R\breve | r2 d d4 d d ef2 | 
        c f d r | R\breve | r1 d2 d4 d | ef2 c f d | R\breve | r4 g bf4.( a8 

    g4) g a bf | a2 d,4 d d d g2 | c,4 c f f d2 bf | 
        \[ \ficta ef1( d) \unficta \] | g1 r1 | r1 r2 d | g f bf4 f g2 |
        d1 r | bf f' | bf2.( a4 g1) | 
...
quintoI = \relative c' {
    ...
    bf1. bf2 | d d1 d2 | d1 c2 c ~ | c g g4( a bf c | d1) bf2 c ~ | 
        c4 c d2 f4.( e8 d4) d | bf2 g4 g' a a g2 ~ | g4( f8[ e] f2) 
    ...
    f4 f d2.( c8[ bf] c4 bf8[ c] | d1) d2 r4 g | f2 g a4 g fs2 | g f d f | 
        f4 f d2 d1 | r2 bf4( c d e f2) | c1 r2 f ~ | f4( e8[ d] e2) f1 |
        R\breve | f2. f4 

    g4 g e e | f2 bf, r2 r4 g' ~ | g g a fs fs fs g2 | c, r2 r r4 g' ~ |
        g g fs fs g g, g2 | f r4 bf2 bf4 c g | a a bf2 g r4 g ~ |
        g c bf g a2 d | d1 d\longa*1/2
