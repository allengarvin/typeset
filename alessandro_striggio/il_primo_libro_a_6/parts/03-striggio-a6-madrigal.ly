...
cantoLyricsIII = \lyricmode {
    ...
    Non po -- ten -- do mi -- rar mio vi -- vo so -- le,
        mio vi -- vo so -- le,
    E la mia vi -- ta~e ri -- a 
    Qual hor __ lo mi -- ro,
    perch’ il guard’ e ta -- le
...
altoLyricsIII = \lyricmode {
    ...
    Che fia dun -- que di me che far mi deg -- gio,
        che far mi deg -- gio,
    S’io mir’ ho ma -- le e s’io non mir’ ho peg -- gio,
    S’io mir’ ho ma -- le e s’io non mir’ ho peg -- gio, __
    \ijLyrics
        e s’io non mir’ ho peg -- gio.
    \normalLyrics
}
...
tenoreLyricsIII = \lyricmode {
    ...
    \ijLyrics
    s’io mir’ ho ma -- le 
    \normalLyrics e s’io non mir’ __ ho peg -- gio,
...
bassoLyricsIII = \lyricmode {
    ...
    \normalLyrics
    Qual hor lo mi -- ro,
    Qual hor lo mi -- ro, perch’ il guard’ e ta -- le
    Che la -- sciar -- mi peg -- gior __ che mor -- te suo -- le,
        che mor -- te suo -- le,
...
sestoLyricsIII = \lyricmode {
    ...
    E la mia vi -- ta~e ri -- a 
    Qual hor lo mi -- ro,
    Qual hor lo mi -- ro, perch’ il guard’ __ e ta -- le
    Che la -- sciar -- mi peg -- gior che mor -- te suo -- le,
        che mor -- te suo -- le,
