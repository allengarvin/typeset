...
\header {
    ...
    partname = "Tenor III (choir II, part 3 of 4)"
    instrument = "Amor, se così dolce e il mio dolore: Dialogo à 8 (tenor III)"
...
\book {
    ...
    \bookOutputSuffix "-ch2-3-tenor_three--tr8_clef"
    \include "../include/paper-1-part.ly"
    \score {
        \new Voice << 
            \clef "treble_8"
...
\book {
    \bookOutputName "28-rore--amor_se_cosi_dolce_e_il_mio_dolore-dialogo_a_8"
    \bookOutputSuffix "-ch2-3-tenor_three--al_clef"
    \include "../include/paper-1-part.ly"
    \score {
        \new Voice << 
            \clef "alto"
