...
\header {
    ...
    instrument = "Amor, se così dolce e il mio dolore: Dialogo à 8 (altusOne)"
    folio = "Anonymous sonnet"

    % Things that change per part:
    partname = "Altus I (choir I, part 3 of 4)"
    instrument = "Amor, se così dolce e il mio dolore: Dialogo à 8 (altusOne)"
...
\book {
    ...
    \bookOutputSuffix "-ch1-3-altus_one--tr8_clef"
    \include "../include/paper-1-part.ly"
    \score {
        \new Voice << 
            \clef "treble_8"
...
\book {
    \bookOutputName "28-rore--amor_se_cosi_dolce_e_il_mio_dolore-dialogo_a_8"
    \bookOutputSuffix "-ch1-3-altus_one--al_clef"
    \include "../include/paper-1-part.ly"
    \score {
        \new Voice << 
            \clef "alto"
