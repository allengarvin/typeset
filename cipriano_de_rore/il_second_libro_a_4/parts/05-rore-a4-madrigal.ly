...
cantoV = \relative c'' {
    ...
    d1 | c2 bf a1 | a b2 b | b b b1 | e, a\breve | a\longa*1/2 \bar "||"
        \time 3/1
        b\breve a1 | g a\breve | b1 b\breve | e, ds1 |
        \fourTwoCutTime
    ...
    e2. c4  | c2 d b c ~ | c a bf g | a1.( g4 f | g2 a) g1 | r1 f' ~ |
        ...
        a gs4 fs gs!1\melfiEnd | a1 r1 | f'1. d2 ~ | d c bf2.( a4 | g1) f' |
...
altoV = \relative c'' {
    ...
    g1 g2 g | g1 f | d ef | d r2 e ~ | e f g a ~ | a c1 bf2 |
        a2 a2.\melfi gs8[ fs] gs!2\melfiEnd | a\breve ~ | a1 r1 | f f |
        f2 d1 c2 | d1 bf' | bf a2 g ~ | g g fs1 | r2 a d,1 | e

    f1 | f2 e d1 | e r2 f | f f e1 | f g | g2 f1 e2 ~ | e e g1 | g r1 | 
        a1 a2 a | a1 bf2 a ~ | a4\melfi gs8[ fs] gs!2\melfiEnd a1 | r1 a1 |
        a2 a a1 | bf2 a2.\melfi gs8[ fs] gs!2\melfiEnd |

    a1 r2 f | bf1 a2 g | f1 e | gs2 gs gs gs | gs1 a | fs\breve | 
        fs\longa*1/2
    \bar "||"
    \time 3/1
        R\breve | r1 e\breve | g1 fs g ~ | g \ficta fs\breve\unficta |
        \fourTwoCutTime
...
bassoV = \relative c {
    ...
    d1 a | e'2 e e e | e1 a | d,\breve | d\longa*1/2 \bar "||"
        \time 3/1
        R\breve. | r1 a'\breve | e1 ds e ~ | e \ficta b\breve\unficta |
        \fourTwoCommonTime
