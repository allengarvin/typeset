...
cantusLIII = \relative c'' {
    ...
    a1 \[ bf1( g) \] | c1.( d2 e d4 e | f1 e2 d c1 |
        ...
        d1 c d | \colorBr e1\colorBrBegin f\breve\colorBrEnd | r1 f\breve |
        c1 d e | 

    f1 \[ d( e) \] | f\breve r1 | R\breve. R | bf,1 bf c | d \[ f1( d) \] |
        \fourTwoCutTime d\breve | \[ bf\breve( | c\longa*1/2) \] 
...
tenorTwoLIII = \relative c {
    ...
    d2 bf1 d2 | c a g1 | \time 3/1
        f\breve. | R\breve.*7 | c'1 c\breve | d1 f\breve | c1 c\breve | 
        bf1 a f' | e f1.( e2 |
        \colorBr d1\colorBrBegin ) c\breve\colorBrEnd | R\breve.* 6 |
        c1 c\breve | d1 f\breve | 

    f1 \[ e( f) \] | \colorBr d1\colorBrBegin c\breve\colorBrEnd |
        R\breve.*6 | r1 c\breve | f,1 g a | bf g a ~ | a2( bf c\breve) |
        R\breve f,1 | g a bf | \colorBr g1\colorBrBegin f\breve \colorBrEnd |
        R\breve. | r1 r c' ~ | c f, g | a bf g | f\longa*1/2
    \bar "|."
}
...
tenorOneLIII = \relative c {
    ...
    f\breve | \[ a1( bf) \] | c\breve | r1 d ~ | d2 f1 c2 ~ | c d2.( c4 bf2 ~|
        bf a) bf1 | R\breve | r2 f a2. bf4 | c1 c2 a | c1 g | a2. bf4
    ...
    % --- page ---
    d2.( c8[ bf] a2) c | c1 r2 g ~ | g bf f2.( g4 | a bf c2) f1 | r2 f e1 |
        f f,2.( g4 | a bf c d e d c bf | a2) d d1 | c d | 

    f1 f2 f ~ | f e g f | f2.( e4 d2) c | c2.( d4 e2) e | f4( e d c d2) r2 |
        c1 d ~ | d2 f2. f4 f2 | e g1 g2 | f2.( e8[ d] 
    ...
    a4 bf c1) c2 | \time 3/1
        c\breve c1 | c\breve d1 | f\breve c1 | c\breve g1 | f a' g |
        f2.( f4 e2. d4 e1) | c c c | \colorBr g1\colorBrBegin f\breve | 

    r1 c' g ~ | g d' c ~ | c r1 f ~ | f f, c'\breve | c\breve. |
        g1 g a | c\breve c1 | c\breve d1 | f f \[ e( | f) d c |
        r1 c c | g f\breve | f \[ c'( a) \] | 
        
    \colorBr bf1\colorBrBegin c\breve\colorBrEnd | R\breve.*2 |
        c\breve bf1 | a1.(g4 f g!) | a g g | a\breve r1 | R\breve. |
        g'\breve c,1 | d e f | 
        \[ \colorBr bf \colorBrBegin ( c) \] a ~ | a \colorBrEnd r1 r1 |
        r1 r1 \colorBr c \colorBrBegin ~ | c f,\breve\colorBrEnd | bf1 a g |
        g a1. bf2 | 

    \colorBr c\breve \colorBrBegin r1 | r1 c \colorBrEnd | f1 d c | 
        \[ f( bf,) \] c | a r1 c | c d e | f c c | bf bf f | bf1 \[ bf( a) \] |
        \fourTwoCutTime
        \[ bf1( f) \] | \[ bf\breve( | f\longa*1/2 ) \] 
    \bar "|."
}
...
bassusLIII = \relative c' {
    ...
    g1 | f r2 c' | a2.( g4 f1) | c\breve | f1 f ~ | f2 c' bf4.( a8 g2) |
        f1 r1 | r1 r2 g | f f2.( g4 a2) | g1 bf | f1. c,2 | g'1. d2 | f1
    ...
    f1.( e4 d c1) | R\breve.*3 | r1 c f | d c f | 
        ...
        R\breve.*2 | c1 f d | c \[ f1( bf,) \] |
        \colorBr c\colorBrBegin f\breve\colorBrEnd | R\breve. | r1 r1 c | 

    f1 f c | \[ bf1( bf,) \] c | f\breve r1 | bf, bf a | bf d\breve |
        \fourTwoCutTime
...
quintusLIII = \relative c' {
    \clef treble
    \key f \major
    \fourTwoCutTime

    R\breve*4 R\breve*5 R\breve*2 | f\breve | \[ a( bf) \] | c | r1 d |
        f c | d2.( c4 bf1) | a r1 | R\breve | c1

    c2 bf ~ | bf4( c d1 c2) | c1 r1 | bf a2 c | c g bf1 | r1 r2 c |
        c bf2.( c4 d2) c1 

    r1 | R\breve*2 | bf1 a | c1. bf2 ~ | bf4( a8[ g] f1) a2 | \[ g1( f) \] |
        R\breve*8 | f1 g | bf2. bf4 bf2 a | c c bf2.( a4 | g2) f 

    f2 a | g1 r1 | R\breve | r1 bf | a bf2 c ~ | c d d1 | R\breve | 
        r2 bf1 a2 ~ | a g1 g2 | f1 r1 | R\breve*2 | r1 bf | a2. a4 c1 |
        d2 bf1 d2 |
    
    c a g1 | f\breve | R | \time 3/1
        R\breve.*6 | 
    ...
    d1 f\breve | f1 \[ e( f) \] | 
        \colorBr d1\colorBrBegin c\breve\colorBrEnd | R\breve.*7 | r1 c\breve|
    ...
    r1 r c' ~ | c f, g | a bf g | f\breve r1 | R\breve.*2 |
        bf'1 bf a | g g d | d\longa*1/2

    \bar "|."
}

quintusLyricsLIII = \lyricmode {
}
