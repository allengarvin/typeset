...
altusX = \relative c' {
    ...
    cs1 | d1. a2 | bf1 a | g fs2.( g4 | a1) r2 e' | e e1 b2 | c\breve | d |
        \bar "||" a1 a | d
...
tenorX = \relative c' {
    ...
    e2 e1 e2 | \[ e\breve( a) \] | gs\breve \bar "||" R\breve*3 | a1 a |
...
bassusX = \relative c {
    ...
    r2 a1 gs2 | a1 e' | a,\breve | e \bar "||" R\breve*2 | a1 a | d a2 d |
        c a a4( b c d | 
...
quintusX = \relative c {
    ...
    a1 r1 | r2 g1 fs2 | g1 a | bf a | r2 c1 b2 | a1 gs | \[ a\breve( e) \] |
        e \bar "||" r1 d | d f | 
