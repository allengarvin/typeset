...
cantusXV = \relative c' {
    ...
    d\breve | c1 d | e f | g2.( f4 e2 d) | c1 r2 e | f2. f4 g2 a |
    ...
    d1 r1 | f\breve | f2 e d c | d1. c2 | bf1 a | d\breve | c1 e | f2 f g g |
...
altusXV = \relative c' {
    ...
    a\breve | a1 a | c d | d2.( c4 bf1) | a r2 c | d d d c | bf4( c d e f2) f |
        ef ef d1 | cs\breve~ cs1 r1 | 
        r2 a \colorBr bf2.\colorBrBegin a4\colorBrEnd  |

    % --- page ---
    g2 f g g | bf2.( c4 d2. c4 | bf2 bf2. a4) a2 ~ | a g a a | bf2. a4 g2 f |
        g g f f | bf\breve | a\longa*1/2 \bar "||"

        a\breve | a2 a \colorBr bf2.\colorBrBegin a4\colorBrEnd |

    
    g1 f ~ | f r1 | r2 d' e d | c bf c g | c a g1 | a2 r4 d d2 d | 
        c bf f'2. f4 | \ficta e2 d\melisma cs4 b\melismaEnd cs!2 | 
        d r4 f f2 f | e d

    f2 f | e d\melisma cs4 b\melismaEnd cs!2\unficta | 
    ...
    g2 | f1 r1 | d'\breve | \colorBr c2.\colorBrBegin bf4\colorBrEnd a2. g4 |
        f1 a | g e2 a ~ | a( g4 f g1) | a2 a c c | d d g,2. g4 | a2 a bf( d |
        c2. bf4 a1 ~ | a) 
...
tenorXV = \relative c {
    ...
    f\breve | e1 f | g bf | bf2.( a4 g2. f4) | e1 r2 a | a a bf c | 
        d1. d2 | bf c f,2.( g4) | a\breve | r2 a a2. g4 |

    % --- page ---
    f2 e f2. e4 | d2 c d d | r2 d bf'2. a4 | g2. f4 e2 c | d d e2. f4 |
        g1 d2 a' | bf1.( a2 | g\breve) | f\longa*1/2 \bar "||"

        d'\breve | d2 d 

    d2 d | c1 a2 a | bf a g f | g4( a bf a c2) d | e d c2.( d4 | 
        e2 d2. c8[ bf] c2) | d r4 a bf2 a | a g a2. a4 | 

    g2 f e1 | d2 r4 d' d2 d | c bf a c | c a a1 | f2 f f f | f f g1 | 
        f2 f f d |
        e e f1 | e2 e e e |

    f1 g | \colorBr e2.\colorBrBegin( d4\colorBrEnd e1) | d r2 d' ~ |
    ...
    g1 | f2 a c c | d2. c4 bf2. a4 | g2 f g1 | a r1 | a\breve | 
        a2 g f e | d1 f | d c2 f ~ | f4( e d c d1) | e r2 a ~ | a bf bf c |

    % --- page ---
    c2 f,2. f4 g2 | g a2.( g4 f e) | f1 g2 d | f f f( d ~ | d) f1 e2 | 
...
bassusXV = \relative c {
    ...
    r1 g ~ | g a | bf a( | g2. a4 bf c d2) | g, g bf f | g\breve | d'\longa*1/2
        ...
        d\breve | d2 d g g | c,1 d ~ | d r2 d | \ficta ef d c bf |

    c2 g c1 ~ | c2 d ef1 | d2 r4 d d2 d | f g d f | c d a1 | d\breve |
        \unficta
        r1 r2 f | c d a1 | d2 d d d | d d 

    g,1 | d'2 d d d | c c d1 | a2 a a a | d1 g, | a a | r2 bf1 bf2 |
        bf\breve | f'1 c | d\breve | a1 r2 d | c bf

    % --- page ---
    f'2 g | d1. d2 | c bf f'1 | g r2 d | f2. e4 d2 c | bf1 a | R\breve |
        r2 d c c | bf2. bf4 bf2 bf | c d\ficta ef1 | \unficta

    d1 r1 | d\breve | f2 c d a | bf1 f | g a | bf\breve | a | d1 ef2 ef |
        f f bf, bf | c c d1 ~ | d g, | r2 d' d d |

    f2. e4 d2 c | d g, a a | r2 d d d | f2. e4 d2. c4 | bf2.( a4 g2) f |
        g\breve d'\longa*1/2
    \bar "|."
}
