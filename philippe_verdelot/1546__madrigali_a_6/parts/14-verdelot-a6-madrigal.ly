...
cantusXIV = \relative c'' {
    ...
    R\breve*4 | R\breve*2 | a\breve | a1 a | a1. a2 | a1 a | a b2 a ~ |
    ...
    c2. b4 | a2 a r a | a a c1 | b2 a2.( g8[ f] g2) | a\breve | r2 a a a |
    ...
    f4( g a f | g f e d e1) | d r1 | R\breve | r2 a' a g | a1 b | 
        c\breve | a1 r2 a | a a c2. b4 | a g a2. g8[ f] g2 | a\longa*1/2
    \bar "|."
}
...
%    Fi -- nir ch'a mez -- zo~e -- ra~il do -- lor a pe -- na,
...
%    Il do -- lor e la vi -- ta~al -- l’o -- re~e -- stre -- me,
...
altusXIV = \relative c' {
    ...
    f2 e d f | e f d f ~ | f4( e d c d1) | c\breve | R | r1 r2 e | f g c, f |
        g a2.( g8[ f]) g2 | a1 r1 | R\breve | a1 a ~ | a2 g f e | d c f1 |
        e 
    ...
    g2 e | f f e2. d4 | c2 a b1 | a r1 | R\breve | r2 e' e e | f1. f2 | 
        f f g g | f1 e | c2. d4 e2 f ~ | f4 e e1 d2 | e\longa*1/2
    \bar "|."
}
...
tenorXIV = \relative c' {
    ...
    c2 a | a g a a | r2 a d, d | a'2.( b4 c d e2 ~ | e4 d8[ c] d2) e1 ~ |
...
quintusXIV = \relative c' {
    ...
    d1 | e\breve | r2 d a' e | f d g' d | e d f2. e4 | d1 r1 | r2 e,1 e2 |
        f1 e2 a | a2. g4 f2 c' | d e2.( d8[ c] d2 | e d) e1 ~ | e r1 |
        R\breve | r1 r2 e |

    f2 e d c | f e d1 | c r2 a | d d a1 | a\breve | r2 a g e | f f g1 |
    ...
    a2 f e e | r1 g | e2 f d1 | e\breve | e1 f2 f | d f e1 | a r1 | 
        e' c2 d | a c b4 a d2 ~ | d c4 b c2. d4 | c\longa*1/2
    \bar "|."
}
...
sextusXIV = \relative c {
    ...
    r1 | R\breve | r1 r2 e | e2. d4 c2 b | a a r1 | r1 r2 d | d d b d ~ | 
        d4( c8[ b] c2 d1) | c2 e e d | e b c a | b1 a | d c | r2 c d1 | e1 r1 |
        R\breve | r2 e 

    e2. d4 | c2 b a a | R\breve | r2 d d d | b d2.( c8[ b] c2 | d1) c2 e |
        e d e b | c a b1 | a d | c r2 c | d d a a | d d e1 |

    d2. c4 b1 | a2. g8[ f] e2 d4 e | f g a2. g4 f2 | e\longa*1/2
