...
cantoXIII = \relative c'' {
    ...
    g4 a b c | d c bf2 bf1 | r2 f1 e4 d | c d e f g e | d2 d1 g2 |

    gs4 a b1 | a a1 g2 | d r4 d' c( b b a8[ g] | a1) g ~ | g r2 g |
        a4 b c2. b4
...
%    Per la dol -- ce ca -- gion del lan -- guir mi -- o
...
tenoreXIII = \relative c' {
    ...
    c4 c8[ b] a1 | r2 a2. d4 c c8[ b] | a2 d c1 | b2 a gs1 | a e fs g |
...
bassoXIII = \relative c {
    ...
    a1 e'2 e ~ | e4 e e2 a, d ~ | d d bf1 | g a2 a' ~ | a 4 g 
