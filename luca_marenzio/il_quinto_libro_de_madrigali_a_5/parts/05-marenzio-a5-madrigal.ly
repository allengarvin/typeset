...
cantoV = \relative c'' {
    ...
    r4 d' d d d4.( c16[ b] | a2 r2 r4 d d d | 
        d4.( c16[ b] a8[ g f e] d4 d' d2 ~ | d( cs4 b) cs\longa*1/2
    \bar "|."
}
...
altoV = \relative c' {
    ...
    r4 g g b | c4.( b16[ a] g8[ f e d] c4) e e2 | g4 d d d d2 g | 
        b b r4 a c c | d4.( c16[ b] a8[ g f e] d2) f | a1 a\longa*1/2
    \bar "|."
}
...
bassoV = \relative c' {
    ...
    r1 | R\breve*5 | r1 r4 c' c c | c4.( b16[ a] g8[ f e d] c2) c | c1 g ~ |
        g r4 d' d d | d4.( c16[ b] a8[ g f e] d2) d | d\breve | 
        a'\longa*1/2
...
quintoV = \relative c' {
    ...
    r2 r4 g' ~ | g fs g2 r2 r4 f ~| f8[ f] a2 gs2 a r2 | r1 r4 a g4. f8 |
