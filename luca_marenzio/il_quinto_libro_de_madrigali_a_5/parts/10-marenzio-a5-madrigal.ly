...
cantoX = \relative c'' {
    ...
    bf4 bf | a1 d2 b | e1 e, | g2. g4 a2 b | c1 d2 e ~ | 
        e4( d8[ c] b2) a r4 e' | d c

    b2 r1 | a2 b c d | r4 e d c b b a2 | g g1 f2 | E1 g | a2 a4 a 

    d4 c b2 | a r4 a a2 d, | e4 c' c c a c b2 | a4 e e e f e

    g2 | g1 r2 g ~ | g c1 b2 ~ | b d1 a2 | a d c b | a1 b | e, fs2 g | 
        a1 b2 c4 d | 

    e2 c b1 | a4 c c4. b8 a4 c c b | a g f2 e r4 g | g4. f8 

    e2 r2 e | e4. d8 c4 e e d c b | a2 g4 e e4. f8g 2 | r2 e' e4. d8 

    c4 e | e d c b a1 | gs\longa*1/2
    \bar "|."
}
...
altoX = \relative c' {
    ...
    e2 f1 g2 | a4 a a a f a g2 | c,1 r1 | r4 e e e c e d2 | g, g'
...
tenoreX = \relative c' {
    ...
    b2 b r4 b | b b c d e1 | e,\longa*1/2
    \bar "|."
}
...
bassoX = \relative c {
    ...
    a a f a g2 | c,1 r1 | c1 a2 e' | g1 d2 d ~ | d b b g | a1 e' | R\breve*3 |
        r4 a
