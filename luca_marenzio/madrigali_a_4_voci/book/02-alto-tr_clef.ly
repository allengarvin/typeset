...
\book {
    \markup { \vspace #2 }
    \score {
        \new Voice << \clef "treble_8" \global \altoI >>
    ...
    \pageBreak
    \score {
        \new Voice << \clef "treble_8" \global \altoII >>
    ...
    \pageBreak
    \score {
        \new Voice << \clef "treble_8" \global \altoIII >>
    ...
    \pageBreak
    \score {
        \new Voice << \clef "treble_8" \global \altoIV >>
    ...
    \pageBreak
    \score {
        \new Voice << \clef "treble_8" \global \altoV >>
    ...
    \pageBreak
    \score {
        \new Voice << \clef "treble_8" \global \altoXIII >>
    ...
    \pageBreak
    \score {
        \new Voice << \clef "treble_8" \global \altoXV >>
    ...
    \pageBreak
    \score {
        \new Voice << \clef "treble_8" \global \altoXVI >>
    ...
    \pageBreak
    \score {
        \new Voice << \clef "treble_8" \global \altoXVII >>
    ...
    \pageBreak
    \score {
        \new Voice << \clef "treble_8" \global \altoXVIII >>
