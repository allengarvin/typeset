...
\book {
    ...
    \pageBreak
    \score {
        \new Voice << \clef alto \global \altoXXII >>
    ...
    \pageBreak
    \score {
        \new Voice << \clef alto \global \altoXXIII >>
    ...
    \pageBreak
    \score {
        \new Voice << \clef alto \global \altoXXVII >>
    ...
    \pageBreak
    \score {
        \new Voice << \clef alto \global \altoXXVIII >>
    ...
    \pageBreak
    \score {
        \new Voice << \clef alto \global \altoXXIX >>
