...
\header {
    ...
    partname = "Tenore I (Choir I, part 3 of 5)"
    instrument = "Vieni Clori gentil (choir I tenore I)"
...
\book {
    ...
    \bookOutputSuffix "--ch1-3-tenore-1--tr8_clef"
    \include "../include/paper-1-part.ly"
    \score {
        \new Voice << 
            \clef "treble_8"
...
\book {
    \bookOutputName "20-marenzio--vieni_clori_gentil"
    \bookOutputSuffix "--ch1-3-tenore-1--al_clef"
    \include "../include/paper-1-part.ly"
    \score {
        \new Voice << 
            \clef alto
