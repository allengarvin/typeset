...
% Invocation: /usr/local/bin/generate-single.py -t "O fido, o caro Aminta" -f GUARINI -l italian -m 88 -p madrigal -v 14-marenzio-a5-0-score.ly --subsubtitle "transposed down" canto:t alto:ta quinto:8a tenore:8a basso:b
...
\header {
    ...
    instrument = "O fido, o caro Aminta:  (canto)"
