...
\header {
    ...
    subtitle = ""
    instrument = "Basti fin qui le pene:  (ChOneAlto)"
    ...
    partname = "Alto I (Choir 1, part 2 of 5)"
    instrument = "Basti fin qui le pene:  (Alto I)"
...
\book {
    ...
    \bookOutputSuffix "--02-ChOneAlto--tr_clef"
    \include "../include/paper-1-part.ly"
    \score {
        \new Voice << 
            \clef "treble"
...
\book {
    \bookOutputName "19-marenzio--basti_fin_qui_le_pene-"
    \bookOutputSuffix "--02-ChOneAlto--al_clef"
    \include "../include/paper-1-part.ly"
    \score {
        \new Voice << 
            \clef "alto"
