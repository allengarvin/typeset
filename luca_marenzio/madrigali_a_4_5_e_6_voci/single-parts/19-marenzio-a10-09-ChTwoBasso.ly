...
\header {
    ...
    subtitle = ""
    instrument = "Basti fin qui le pene:  (ChTwoBasso)"
    ...
    partname = "Basso II (Choir 2, part 5 of 5)"
    ...
    instrument = "Basti fin qui le pene:  (Basso II)"
...
\book {
    ...
    \bookOutputSuffix "--10-ChTwoBasso--bs_clef"
    \include "../include/paper-1-part.ly"
    \score {
        \new Voice << 
            \clef "bass"
