...
\header {
    ...
    subtitle = ""
    instrument = "Basti fin qui le pene:  (ChOneBasso)"
    ...
    partname = "Basso I (Choir 1, part 5 of 5)"
    ...
    instrument = "Basti fin qui le pene:  (Basso I)"
...
\book {
    ...
    \bookOutputSuffix "--05-ChOneBasso--bs_clef"
    \include "../include/paper-1-part.ly"
    \score {
        \new Voice << 
            \clef "bass"
