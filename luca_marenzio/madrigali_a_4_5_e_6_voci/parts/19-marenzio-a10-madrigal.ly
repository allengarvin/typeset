...
ChOneAltoXIXincipit = \relative c'' {
    \clef "petrucci-c2"
    \key f \major
    \time 2/2
...
ChOneCantoXIXincipit = \relative c'' {
    \clef "petrucci-g"
    \key f \major
    \time 2/2
...
ChTwoAltoXIXincipit = \relative c'' {
    \clef "petrucci-c2"
    \key f \major
    \time 2/2
...
ChTwoCantoXIXincipit = \relative c'' {
    \clef "petrucci-g"
    \key f \major
    \time 2/2
...
ChOneTenoreOneXIXincipit = \relative c' {
    \clef "petrucci-c3"
    \key f \major
    \time 2/2
...
ChOneTenoreOneLyricsXIX = \lyricmode {
...
ChOneTenoreTwoXIXincipit = \relative c' {
    \clef "petrucci-c3"
    \key f \major
    \time 2/2
...
ChOneTenoreTwoLyricsXIX = \lyricmode {
    Ba -- sti fin qui le __ pe -- n'e~i du -- ri~af -- fan -- ni
    In tan -- te car -- te,
...
ChOneBassoXIXincipit = \relative c' {
    \clef "petrucci-f3"
    \key f \major
    \time 2/2
...
ChTwoTenoreTwoXIXincipit = \relative c' {
    \clef "petrucci-c3"
    \key f \major
    \time 2/2
...
ChTwoTenoreTwoLyricsXIX = \lyricmode {
...
ChTwoBassoXIXincipit = \relative c {
    \clef "petrucci-f3"
    \key f \major
    \time 2/2
...
ChTwoTenoreOneXIXincipit = \relative c' {
    \clef "petrucci-c3"
    \key f \major
    \time 2/2
...
ChTwoTenoreOneLyricsXIX = \lyricmode {
...
ChOneCantoXIXincipitVoice = <<
    \new MensuralVoice <<
        { s1 \noBreak }
        \ChOneCantoXIXincipit
    >>
>>

ChTwoAltoXIXincipitVoice = <<
    \new MensuralVoice <<
        { s1 \noBreak }
        \ChTwoAltoXIXincipit
    >>
...
ChTwoCantoXIXincipitVoice = <<
    \new MensuralVoice <<
        { s1 \noBreak }
        \ChTwoCantoXIXincipit
    >>
>>

ChOneTenoreOneXIXincipitVoice = <<
    \new MensuralVoice <<
        { s1 \noBreak }
        \ChOneTenoreOneXIXincipit
    >>
>>

ChOneTenoreTwoXIXincipitVoice = <<
    \new MensuralVoice <<
        { s1 \noBreak }
        \ChOneTenoreTwoXIXincipit
    >>
>>

ChOneBassoXIXincipitVoice = <<
    \new MensuralVoice <<
        { s1 \noBreak }
        \ChOneBassoXIXincipit
    >>
>>

ChTwoTenoreTwoXIXincipitVoice = <<
    \new MensuralVoice <<
        { s1 \noBreak }
        \ChTwoTenoreTwoXIXincipit
    >>
>>

ChTwoBassoXIXincipitVoice = <<
    \new MensuralVoice <<
        { s1 \noBreak }
        \ChTwoBassoXIXincipit
    >>
>>

ChTwoTenoreOneXIXincipitVoice = <<
    \new MensuralVoice <<
        { s1 \noBreak }
        \ChTwoTenoreOneXIXincipit
    >>
>>
