...
% Invocation: /usr/local/bin/generate-single.py -t "Dentro pur foco" -u "Sesta parte" -m 78 -v -p canzone -f PETRARCA -l italian 08-marenzio-a6-0-score.ly canto:t alto:ta quinto:ta sesto:8a tenore:8a basso:b
...
\header {
    ...
    subsubtitle = ""
    instrument = "Dentro pur foco: Sesta parte (quinto)"
