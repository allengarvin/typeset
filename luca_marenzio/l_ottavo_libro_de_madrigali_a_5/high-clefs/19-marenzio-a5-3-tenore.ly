...
% Invocation: /usr/local/bin/generate-single.py -t "Ferir quel petto, Silvio" -u "Terza parte" -v -m 80 -l italian -p "verso sciolto" -f GUARINI 19-marenzio-a5-0-score.ly --subsubtitle "transposed down" canto:t alto:8a quinto:8a tenore:8a basso:b
...
\header {
    ...
    instrument = "Ferir quel petto, Silvio: Terza parte (tenore)"
