...
% which death now renders, alas! dark and closed;
% O countenance once of flame, now snowy;
% O mouth once rosy, now violet blue,
% do I behold you and not die? Beloved Alcippus,
% you ignited my fire, now you are icy,
% and does your chill not extinguish my blaze?
% Woe is me that I see you! O grieving eyes,
% fountains of darkness and weeping,
% you have seen too much: now you close forever.
% Ah! no more tears, no more words,
% no more sighs; only death alone
% may be a witness to my suffering.
% Beautiful soul, if you be here
% near your lovely body, and see and hear
% my grief and my abject cries,
% ah! for pity’s sake, if there still be pity for me,
% take me with you, that I might follow you. —At this
% Alcippus revived and, opening his weary eyes,
...
cantoI = \relative c'' {
    ...
    e2 ~ | e e r4 c' a4. a8 | a4 g fs fs4. fs8 g4 a2 | a r4 d a4. a8 a4 g | 
        fs4 fs4. fs8 g4
...
altoI = \relative c' {
    ...
    g,4 g | r4 a f' d c2 d | r2 d4 e f g2 d4 | f2 f1 g2 ~ |
        g4 fs fs2 g1 | g4 g2 f4 f f e4. e8 | d4 d f1 f2 | r2 d1 g2 ~ | g
    ...
    f2. f4 | e2 e r g ~ | g f4 f4. f8 d4 d4. bf'8 | a4 g fs2 fs4 bf a g |
        fs2 fs g8[ g g g] a1 ~ | a2 a f4 f8[ f] f4 f | 
        e2
...
tenoreI = \relative c' {
    ...
    d4 g,2 g4 | c2 c bf bf | d1 d | r4 g, g a a a e c' | d c c1 c2 | 
        r2 bf1 d2 ~| d c1 e2 ~ | e a,4 d8[ d] g,2 a | R\breve*2 |
...
bassoI = \relative c {
    ...
    d4 a c4. c8 | b4 c f,1 f2 | r2 bf1 g2 ~ | g c1 a2 ~ |
        a d4 d8[ d] ef2 d | R\breve*2 | r1 f4 f8[ f] d4 a | d2. c4 bf2. a4 |
        c2 c
...
quintoI = \relative c' {
    ...
    c2 | c r r1 | R\breve | r4 d8[ d] d2. g8[ a] c4 c | R\breve |
