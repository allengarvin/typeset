...
% superius: checked against source 2022
...
mediusV = \relative c' { 
    ...
    r2 a | b1 c2 d ~ | d c2 bf r4 g | a2 b c a4 c ~ | c b8[ a] b!2 c4 g a2 |
        bf4. c8 bf4 a c \ficta b!\unficta a d, | r2 e f4. g8 a2 | 
        a1 r2 c | b a g f | e1 fs2

    a ~ | a a2 a2. a4 | g2 e f4. g8 a2 ~ | a4 g e2 fs1 ~ | fs r2 a | b1 c2 d ~ |
        d c b r4 g | a2 b c a4 c ~ | c b!8[ a] b2 c4 g a2 | b4. c8 b4 a c 

    bf a d, | r2 e f4. g8 a2 | a1 r2 c | b a g f | e1 f2 a ~ | 
        a a2 a2. c4 | b1 a | a\longa*1/2\fermata
    \bar "|."
...
contraV = \relative c' {
    ...
    a1 d2. c4 | a2 bf a c ~ | c d r1 | e2 a2. g4 e2 | f1 d | c2 bf c a |
        a1 r2 e' | f d cs2. d4 | e1 r1 | a,2 c bf a | g1 r2 d' | c d e d | 
        g,1 a |

    r2 d e fs | g2. \ficta f4 \unficta e2 d ~ | d r2 r d | f g1 f2 | 
    ...
    f | g2 c, r a ~ | a a2 a f' | e d c d | d1 r2 e | 
        fs4 g a2 fs\longa*1/4\fermata
    \bar "|."
}
...
tenorV = \relative c' {
    ...
    a2 | d1 r2 a | b2 c d b | d1 c | r2 d e f | g d g f | e1 d2 f4. e8 |
        d2 d c4. d8 e4 f | g2 c, r a ~ | a a a f' | e d
                                                      ...
                                                      % vvv ds, error
    cs d4. c8 | bf2 a a1 | e' a, | r2 d e fs | g2. f4 e2 d ~ | 
        d r r \ficta d \unficta | f g1 f2 | a g1 c,2 | d4 g2 f4 e2 a, | 
        r1 r2 d | f4. g8 a2 a1 | d,2

    f4. e8 d4. cs8 d2 ~ | d cs2 d1 | a1 r2 a | b4 c d1 cs2 | d1 a\longa*1/4\fermata 
    \bar "|."
} 
...
bassusV = \relative c {
    ...
    g2 f g d | a'1 d, | cs2 d a' d, | g2. g4 a1 | d,\longa*1/2\fermata
    \bar "|."
}
