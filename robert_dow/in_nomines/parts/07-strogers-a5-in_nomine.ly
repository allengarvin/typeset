...
superiusVII = \relative c'' {
    ...
    R\breve | r2 d f2. e4 | d2 c bf2. a8[ g] | f1 g2 a | bf1 a2 f ~ | f g1. |
        a1 r2 g | c2. bf4 a2 c | f2. e4 d1 | g2. f4 e d e2 | f1 c2 d ~ |
        d1 d2 g2 ~ | g4 f4 e d c1 ~ | c2 c f2. e4 | d2 c d d ~ | d cs d1 | 
    ...
    g2 fs4 g2 | fs4 d2 g4 e e2 c4 | c2 f4 f2 e4 f c ~ | c c f2 e d |
        d d4 g2 g4 f ef ~ | ef d f2 e4 d2 cs4 | d2 e f c4 f ~ |
        f f e d f2 e4 f ~ | f f c2 c4 a2 f'4 | e2 e4 c d2 c | c4 f2 e4 d2

    g4 g ~ | g e d2 f4 f2 f4 _\markup "1" |
        e2 r4 d c a d2 ~ | d4 c d2 r4 g e c | f2 c r4 f d bf | 
        f'2 c4 e d1 | r4 g e c c2 r4 c | a f f1 r4 f' | d bf bf1 d2 |
        bf r4 ef d bf ef2 | g c, d4 f2 e4 | d2. c4

    bf2 c _\markup "2"| e d r4 c4. bf8 c4 | a f2 c'4 a2 f | 
        r4 f'4. e8 f4 d bf bf2 | f' c r4 f4. e8 f4 | d c f2 r4 f4. e8 f4 |
        d bf f'2 c r4 g'4 ~ g8[ f] g4 e c c1 |
        r4 f4. e8 f4 d bf f'2 | c4 d e2 e c ~ | c _\markup "3" r4 g'4. 

    % --- page ---
       % vvv e4 to f4
    f8 g4 f d | g2 d4 f d2 e | cs r4 c4. bf8 c4 g a | b2 a r4 d4. c8 d4 |
        a2 r4 g'4. f8 g4 d2 | f d d1 | r4 g4. f8 g4 d e f2 
        d1 d\longa*1/2
