...
cantoII = \relative c' {
    ...
    g2 ~ | g4) e a1( g2) | a1 r2 a | b1. b2 | c1. c2 ~ | c4 c c2 c4 a d2 ~ |
    ...
    c4 b r4 c r4 b c b | a g f2 e r4 e | f g a2 g r4 g | a b c2. b4 c d |
        e2.( d8[ c] d2) e | c2.( b8[ a] b1) | a r1 | R\breve | r4 e 
...
altoII = \relative c' {
    ...
    r2 r4 d | g2 g4 e4. d8 d4. c8 c4 | b c2( b4) c1 | r2 c g'4 g e2 | 
        a,1 g2 g' ~ | g f1 e2 ~ | e d1( c2) | d b2 d4 d e e | c2 g'1 e2 ~ |
        e4( d8[ c] \[ d1 c2 ~ | c) \]

    \[ b1( a2 ~ | a) \] g1\melisma \ficta fs2 \unficta \melismaEnd | 
        g2 r4 d' g4. g8 fs4 g |
        g2 e f e | g1 g2 r4 g | g a r4 g r4 a g a | e d c2 g'1 ~ | 
        g r2 r4 a | a gs r4 a r4 gs 

    a4 g | f e d2 cs r4 c | d e f2 e r4 e ~ | e f g a2 g4 a b |
