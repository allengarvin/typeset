...
cantusLyricsI = \lyricmode {
    ...
    Ed io pian -- gen -- do giun -- go~al fin del vi -- ver mi -- o,
    Ed io pian -- gen -- do giun -- go~al fin del __ vi -- ver mi  -- o
    Stra -- n'e di -- ver -- sa sor -- te
    Ch'ei mo -- re scon -- so -- la -- to
    Ed io mo -- ro be -- a -- to. __
    Mor -- te che nel mo -- ri -- re __
    M'em -- pie di gio -- ia tut -- ta~e di de -- si -- re.
