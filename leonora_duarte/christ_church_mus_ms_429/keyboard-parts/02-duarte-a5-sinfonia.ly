...
cantoOneII = \relative c'' {
    ...
    b2 | c1 d | e r1 | s\breve | r1 r2 d | e g c, d | e g f e | d1 c |
        r2 d cs d ~ | d
...
cantoTwoII = \relative c'' {
    ...
    << { \stemUp 
          c2 c4 c b4. a8 g[ a b g] | a4 c2 b4 c b a2 | 
          g4 g' g g f4. e8 d[ e f d] | e4 g2 fs4 g4 e d4. e8 | 
          f4 f f f e d c8[ b] a4 | d d e8[ f g e] f4 d8[ e] f[ g a f] |
          g2 a s1 
    | R\breve | g2
    ...
    e4 f g2 ~ | g fs g4 f e d | e d c1 b2 | c1 r1 | s\breve | s1 s2 g' ~ |
        g e f g ~ | g4 f e2 d4 c c2 ~ | c b

    c1 | s\breve*2 | s2 g'1 f2 | d f e4 d d2 ~ | d cs d e | f f, g1 |
    ...
    c4 ~ | c b8[ a] b2 g1 | e'4 e e d8[ c] b2 r4 b | d2 c1 b2 | c\longa*1/2
       ...
       { \stemDown
        s1 g2 g4 g | f4. e8 d[ e f d] e4 g2 fs4 | g4. a8 b4 c d c2 b4 |
        c2. c4 b g g2 | a4 a a a g2 a | d, s2 s1 | r4 c' c c b8[ a g a] b4 b |
    ...
    d2 g1 | s2 e f g | a b c c ~ | c4 b a g a2 f | g1 r2 r8 f[ a f] | c'2 a 

    g2 a | g1 a ~ | a r2 a4 a | a g8[ f] e2 r d | d g2. fs8[ e] fs2 | 
        g1 r2 g | a

    g2 a4 a a g8[ f] | e1 r4 d d8[ c b a] | g4 g' fs2 g1 | s1 c4 c c b8[ a] |
...
tenorII = \relative c' {
    ...
    R\breve*2 | r1 d2 d4 d | 
    << { \stemUp c4. b8 a[ b c a] b4 c2 b4 | c2 d s1 |
        g2 g4 g f4. e8 d[ e f d] | e1 s1 | 
    d2 d4 d c4. b8 a[ b c a] | b4 d2 cs4 d1 | s1 d2 d4 d |
        c4. b8 a[ b c a] b4 c2 b4 | c\breve |

    R\breve*2 R\breve 
        | g'2 e1 f2 | g4 f e d c2 d ~ | d4 c c1 b2 | c1 s1 | s\breve |
        s2 g'1 e2 | f g1 f2 | e1

    d | g, s1 | s1 s2 g' | f e d g, | s1 c2. b4 | a1 d | 
        g,2 r8 c[ e c] g'2 d | s\breve |

    r4 c c4. b8 a4 a' a4. g8 | f4 d d4. c16[ b] a1 | s\breve | g2 b4 g d'1 |
        g, r2 c | f, c' 

    s1 | c4 c c b8[ a] g1 | s1 r4 d' e c | g'1 c, | r2 e4 e e d8[ c] b4 g |
        b2 c d1 | c\longa*1/2

        } \\
       { \stemDown s1 g2 g4 g | f4. e8 d[ e f d] e4 g2 fs4 | 
        g4. f8 e2 d4 d' d d | c4. b8 a[ b c a] b4 c g2 

    s1 a2 a4 a | g4. f8 e[ f g e] f2 g | c, d g1 |
        c,2 f g1 | 

    c,1 s1 | s\breve*3 % R\breve R R\breve | 
        r2 c' a1 | bf2 c1 bf2 | a1 g | s1 s2 g | c c, d e | f g

    c,1 | s\breve | s1 s2 d' ~ | d bf c d ~ | d4 c bf a g1 | a2. g4 f2 e |
        d1 c | f2. e4 d1 |

    c1. r2 | r2 r8 f[ a f] c'[ c, e c] f[ f, a f] | c'1 f,4 f' f4. e8 | 
        d1 d2 a' ~ | a c4 c 

    c4 b8[ a] g2 ~ | g r r d | e4 c g'2 c,1 | r2 c' f, c' | s1 s2 g |
        b4 g d'2 g, r | s1 s2 c, |
