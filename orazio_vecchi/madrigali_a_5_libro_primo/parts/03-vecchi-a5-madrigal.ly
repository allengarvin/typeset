...
cantoIII = \relative c'' {
    ...
    fs2 g ~ | g4 fs8[ e] fs2) g1 | \time 3/2\threeFromOne
    ...
    bf1 a2 | bf bf c | ef2. ef4 d2 | c c c |
        ...
        \fourTwoCommonTime\oneFromThree b1 r1 | R\breve*4 R\breve*3
        \time 3/2\threeFromOne
        bf2 c f, |
...
cantoLyricsIII = \lyricmode {
    Deh, dim -- mi,
    deh, dim -- mi vi -- ta mi -- a s'ho da mo -- ri -- re
    Do -- po~un lun -- go mar -- ti -- re: No, no, cor mi -- o
    \ijLyrics
        no, no, cor mi -- o
    \normalLyrics
    Vi -- vi lie -- ta~e con -- ten -- t'il tuo de -- si -- o,
    vi -- vi lie -- ta~e con -- ten -- t'il tuo de -- si -- o,
        con -- ten -- t'il tuo de -- si -- o,
    vi -- vi lie -- ta~e con -- ten -- t'il tuo de -- si -- o,

    % Deh dim -- mi vi -- ta mi -- a se sem -- pre ma -- i
    % ho da vi -- ver in gua -- i.
    No, no, cor mi -- o
    \ijLyrics
        no, no, cor mi -- o
    \normalLyrics
...
altoIII = \relative c' {
    ...
    f1 f2 e | d\breve( | ef1) d ~ | d r1 | \time 3/2\threeFromOne
        g2 g d | f1 f2 | e e g |
    ...
    ef2 d ef | bf f'1 | bf,2 f' f | g2. c,4 f2 | f f e4 f | g1( fs2) |
        \fourTwoCommonTime\oneFromThree g1 ef ~ | ef d ~ | d2 d

    g1 | g,2 g4 bf2 c4 a2 | a4 a a bf c2 c | d4 c bf a8[g ] a2 g4 g' | fs2 g 

    f4 e d c8[ bf] | a1 g | \time 3/2\threeFromOne
...
altoLyricsIII = \lyricmode {
    Deh, dim -- mi vi -- ta mi -- a s'ho da mo -- ri -- re
    Do -- po~un lun -- go mar -- ti -- re: __ No, no, cor mi -- o
    \ijLyrics
        no, no, cor mi -- o
    \normalLyrics
    Vi -- vi lie -- ta~e con -- ten -- t'il tuo de -- si -- o,
...
bassoIII = \relative c' {
    ...
    R\breve*4 R\breve*5 R\breve | \time 3/2\threeFromOne
        g2 c, bf | f'1 f2 | c c g | 

        d'1 d2 | R1.*4 | r2 d a | bf2. bf4 f'2 | d f bf, | 
        \colorBr c2 \colorBrBegin d1 \colorBrEnd g,1 r2 | R1.*2 | 

    r2 bf f' | c2. c4 bf2 | f'2 f, c' | \colorBr g2\colorBrBegin d'1\colorBrEnd
    ...
    \time 3/2\threeFromOne
        g2 c, bf | f'1 f2 | c c g | d'1 d2 | R1.*3 R1. | r2 d a | bf2. bf4 f'2 |
        d f bf, | 
...
quintoIII = \relative c' {
    ...
    R1.*3 | r2 \bracketify r2 d2 | bf bf bf | bf c1 | 
        d2 d a | c2. g4 bf2 | 
        a a g | d' d1 | \fourTwoCommonTime\oneFromThree d1 r1 | R\breve*4 | 
        R\breve*3
