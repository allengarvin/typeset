...
\header {
    ...
    subtitle = ""
    subsubtitle = "canto part fully texted"
...
\book {
    ...
    \bookOutputSuffix "full_text--0-score"
    \score {
         <<
            \new ChoirStaff = choirStaff \with {
             ...
             \addlyrics { \cantoLyricsXXIVa }
             \addlyrics { \cantoLyricsXXIVb }
             \addlyrics { \cantoLyricsXXIVc }
             \addlyrics { \cantoLyricsXXIVd }
             \addlyrics { \cantoLyricsXXIVe }
             \addlyrics { \cantoLyricsXXIVf }
             \addlyrics { \cantoLyricsXXIVg }
             \addlyrics { \cantoLyricsXXIVh }
             \addlyrics { \cantoLyricsXXIVi }
                \new Voice <<
