...
% Invocation: /usr/local/bin/generate-single.py -t "Benché siate usi" -l italian -p madrigal -l italian -v -m 84 -f Prologo 01-vecchi-a5-0-score.ly --subsubtitle "transposed down" canto:t alto:8a tenore:8a quinto:8a basso:b
...
\header {
    ...
    instrument = "Benché siate usi:  (tenore)"
