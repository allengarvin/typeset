...
cantoXIX = \relative c'' {
    ...
    R\breve | \repeat volta 2 {
        c2 c4 c c2. g4 | a b c d e c f e | d2 e e4 e e2 ~ |
...
altoXIX = \relative c' {
    ...
    c2 c4 c c2. g4 | \repeat volta 2 {
        a b c d e c f e | d2 c4 g'2 a4. b8 c4 ~ | c b c c, e c g'2|
    ...
    % vv e4 to d4
    g4 d f2 e g | c c4 c c b a2 | g4 b c a g1 | 
    }
    \alternative { { r4 c, c c c2. g4 } 
...
bassoXIX = \relative c' {
    ...
    R\breve \repeat volta 2 { 
    R\breve*2 | r2 c c4 c c2 ~ | c4 g a b c g a f | c' b a2 g4 e f2 | 
