...
cantoLyricsXXII = \lyricmode {
    Chi sa -- li -- là per me ma -- don -- na~in cie -- lo
    A ri -- por -- tar -- n'il mio per -- du -- to~in -- ge -- gno?
    Che poi ch'u -- scì di bei vo -- stri~oc -- chi~il te -- lo
    Che'l cor mi fiss' __ o -- gne~or per -- den -- do ve -- gno.
    Né di tan -- ta iat -- tu -- ra mi que -- re -- lo,
    Pur che non cre -- sca
    \ijLyrics pur che non cre -- sca \normalLyrics
    \ijLyrics pur che non cre -- sca \normalLyrics
        ma stia a que -- sto se -- gno; __
    Ch'io du -- bi -- to se più si va sce -- man -- do,
    Che stol -- to me n'an -- drò pe'l mon -- do er -- ran -- do,
    che stol -- to me n'an -- drò pe'l mon -- do er -- ran -- do,
    ch'io du -- bi -- to se più si va sce -- man -- do,
    che stol -- to me n'an -- drò pe'l mon -- do er -- ran -- do,
    che \ijLyrics stol -- to me n'an -- drò __ \normalLyrics 
...
altoLyricsXXII = \lyricmode {
    ...
    Né di tan -- ta iat -- tu -- ra mi __ que -- re -- lo, __
    Pur che non cre -- sca
    \ijLyrics pur che non cre -- sca \normalLyrics
    \ijLyrics pur che non cre -- sca \normalLyrics
        ma stia a que -- sto se -- gno;
    Ch'io du -- bi -- to se più si va sce -- man -- do,
        se più si va sce -- man -- do,
    Che stol -- to me n'an -- drò pe'l mon -- do~er -- ran -- do,
    \ijLyrics
    che stol -- to me n'an -- drò pe'l mon -- do~er -- ran -- do,
    \normalLyrics
    ch'io du -- bi -- to se più si va sce -- man -- do,
        se più si va sce -- man -- do,
    che stol -- to me n'an -- drò
    \ijLyrics che stol -- to me \normalLyrics n'an -- drò pe'l mon -- do~er -- ran -- do,
    che \ijLyrics stol -- to me n'an -- drò pe'l mon -- do~er -- ran -- do. \normalLyrics 
}
...
bassoLyricsXXII = \lyricmode {
    Chi sa -- li -- là per me ma -- don -- na~in cie -- lo
    A ri -- por -- tar -- n'il mio per -- du -- to~in -- ge -- gno? __
    Che poi __ ch'u -- scì di bei vo -- stri~oc -- chi~il te -- lo
    Che'l cor mi fiss' o -- gne~or per -- den -- do ve -- gno.
    Né di tan -- ta iat -- tu -- ra mi __ que -- re -- lo,
    Pur che non cre -- sca
    \ijLyrics pur che non cre -- sca \normalLyrics
    \ijLyrics pur che non cre -- sca \normalLyrics
        ma stia a que -- sto se -- gno; __
