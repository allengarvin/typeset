...
cantoIII = \relative c'' {
    ...
    c2) c d4 d d d | c4( bf8[ a] g4 a8[ bf] c4 bf8[ a] g2) | a1 r1 |
        R\breve*4 | f2 f1 f2 | f e d1 ~ | d2 d

    g4 a2 bf4 | c4.( d8 a4. bf8 f8[ e f g] a[ g f e] | d4) g f2 g1 |
        r4 c c4. bf8 a4 a g8([ f g a] |

    bf[ a bf c] d2) c1 | r4 bf bf bf a2 c4 c | c bf2 a4 a1 |
        a1 r4 d a8([ g a bf] | c2) g8([ f g a] 

    bf2) f8([ e f g] | c4) c c2 c1 | R\breve | r2 r4 f d8([ c d e] f2) |
        a g r2 r4 f | a8([ g a bf] c2) g8([ f g a] 

    bf4) f | r1 c4 c8[ c] c4 f, | c'2 c g4 g8[ g] g4 a |
        bf8([ g] c2 b4) c2 r2 | g4 g8[ g] g4. a8 bf2 bf | r1

    c4 c8[ c] c4 d | c2 c4 c a8([ g a bf] a2) | 
        r4 c g8([ f g a] bf2) f8([ e f g] | a2) e8([ d e f]

    g4) a g2 | a1 r1 | R\breve | d1 c | bf a2 g ~ | g f1 e2 | 
        f1 g4 g8[ g] g4 a | c4 c8[ c] c4 f, g a 

    g2 | g r2 c4 c8[ c] c4 c | d2 d r1 | g,4 g8[ g] g4 bf g f g2 | 
        a1 c2 c4 c |
        c2 d c\breve
        c\longa*1/2
    \bar "|."
...
altoIII = \relative c' {
    ...
    f1 f ~| f f2 f | f1. f2 | e1. e2 | r4 e fs g c,1 ~ | c2 f f4 f f f |
    % --- page ---
...
tenoreIII = \relative c' {
    ...
    f4 c'2 c,4 g'2 d | e1 d | d' c | bf a4 f c'2 | 
        f,4 c' a8([ g a bf] c2) g8([ a bf a] | bf2) f8([ e f g])
...
quintoIII = \relative c' {
    ...
    g4 f c'2 f,4 c' a8([ g a bf] | c2) g8([ f g a] bf2) f8([ e f g] |
        a4) f2 a4 bf2 r4 bf | a8([ g a bf] c2) 
...
sestoIII = \relative c'' {
    ...
    a2) a bf4 bf bf bf | g( a8[ bf] c4 bf8[ a] g4 a8[ bf] c2) |
        R\breve*4 | r1 bf2 bf ~ | bf bf a g | g1. g2 |

    c4 c2 bf4 a4.( bf8 c4. d8 | a8[ g a bf] c4) a g8([ a bf c] d[ c a bf] |
        c1) c2 r2 | r4 c c c 

    bf4 g f8([ e f g] | a8[ bf] c4. bf8 g4) a1 | r4 d d d c2 a4 g | 
        g g2 f4 e2 e | r4 a

    f8([ e f g] a2) r4 d | a8([ g a bf] c2) g8([ f g a] bf2) | 
        c4 a g2 a1 | R\breve | r1 d | c bf | a2 g1 f2 ~ | f( e) f1 | 

    g4 g8[ g] g4 a c4 c8[ c] c4 f, | g( a g2) g r2 | 
        c4 c8[ c] c4 g d'2 d | r1 g,4 g8[ g] g4 bf | 

    g4( f g2) c1 | r2 r4 c g8([ f g a] bf2) | f8([ e f g] a2) bf4 c c2 |
        c1 r1 | r1 r2 r4 f, | d8([ c d e] f2) a g | 

    r2 r4 f a8([ g a bf] c2) | g8([ f g a] b4) f r1 | c'4 c8[ c] c4 f, c'2 c |
        g4 g8[ g] g4 a b( c2 b4) | 

    c2 r2 g4 g8[ g] g4 g | bf2 bf r1 | c4 c8[ c] c4 d c1 | c g2 g4 g |
        g2 bf g( f) g1
        a\longa*1/2
