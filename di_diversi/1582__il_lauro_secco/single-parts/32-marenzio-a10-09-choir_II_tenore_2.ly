...
\header {
    ...
    subtitle = ""
    subsubtitle = ""
    instrument = "Quel lauro, che fu in me già:  (Tenore 2 (Choir II, part 4 of 5))"
...
\book {
    ...
    \bookOutputSuffix "--09-choir_II_tenore_2--tr8_clef"
    \include "../include/paper-1-part.ly"
    \score {
        \new Voice << 
            \clef "treble_8"
...
\book {
    \bookOutputName "32-marenzio--quel_lauro_che_fu_in_me_gia-"
    \bookOutputSuffix "--09-choir_II_tenore_2--al_clef"
    \include "../include/paper-1-part.ly"
    \score {
        \new Voice << 
            \clef "alto"
