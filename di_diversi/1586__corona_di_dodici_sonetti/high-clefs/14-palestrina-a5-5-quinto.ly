...
% Invocation: /usr/local/bin/generate-single.py -f "Giovanni Battista Zuccarini (1550-?)" -t "Per mostrar gioia del connubio" -m 80 -l italian -v -p sonnet -c "Giovanni Pierluigi da Palestrina (c.1525-1594)" 14-palestrina-a5-0-score.ly --subsubtitle "transposed down" canto:t alto:8a quinto:8a tenore:8a basso:b
...
\header {
    ...
    instrument = "Per mostrar gioia del connubio:  (quinto)"
