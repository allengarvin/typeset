...
discantusI = \relative c'' {
    ...
    a1 | f'2. f4 f2 d | d d bf1 | a2 f' e f | d c c1 | R\breve | g'1 f2 f |
          % vv f1 to e1
        f e e1 | R\breve*2 | r1 d | g2 g e1 | f\breve | r2 c c c | bf1 d | 
        R\breve | d1
...
altusI = \relative c' {
    ...
    c2 f2.( e4 d e | f g a2) g1 ~ | g f | r1 a2. a4 | c2 bf r1 | \[ a1( bf) \]|
        a2 f2.( e8[ d] e2) | f\breve~f~f\longa*1/2
    \bar "|."
}
...
altusLyricsI = \lyricmode {
    ...
    Al -- le -- lu -- ia.
    Et u -- ni -- ver -- sa mul -- ti -- tu -- do
        Ja -- cob ca -- ne -- bat __ le -- gi -- ti -- me, __
    et Da -- vid cum can -- to -- ri -- bus ci -- tha -- ram
        per -- cu -- ti -- e -- bat in do -- mo Do -- mi -- ni,
            in do -- mo Do -- mi -- ni, __
    et lau -- des De -- o ca -- ne -- bat,
    \ijLyrics
    et lau -- des De -- o ca -- ne -- bat, __
    \normalLyrics
    et lau -- des De -- o ca -- ne -- bat,
    \ijLyrics
    et lau -- des De -- o ca -- ne -- bat.
...
bassusI = \relative c {
    ...
    f\breve | r1 c | f2 f d1 | c2 c a1 | c r1 | bf ef2 ef | c1 bf | f' g |
        c, r1 | R\breve | r2 c' bf f |

    g2 a bf c | f,1 r1 | c c2 g | c1 r1 | r1 c | c2 bf c1 | r2 f bf, bf | 
        f'2.( e4 
...
%    Al -- le -- lu -- ia.
    Et u -- ni -- ver -- sa mul -- ti -- tu -- do
        Ja -- cob ca -- ne -- bat le -- gi -- ti -- me,
    et Da -- vid cum can -- to -- ri -- bus ci -- tha -- ram
        per -- cu -- ti -- e -- bat __ in do -- mo Do -- mi -- ni,
    \ijLyrics
            in do -- mo Do -- mi -- ni,
    \normalLyrics
    et lau -- des De -- o ca -- ne -- bat.
...
quintaVoxI = \relative c' {
    ...
    c2 c c c | bf g g1 | r2 c d1 ~ | d2 e f1 | c r1 | g c2 c | a1 f2 f | g1 f |
        ...
        a4\melisma bf c2.\ficta b8[ a] b!2\unficta\melismaEnd |
    ...
    c2 d c1 | r2 c bf bf | c f, g g ~ | g4( a bf c d2) c ~ | c a a c ~ | 
        c d g, a ~ | a f f f ~ | f a g1 | f\breve~f~f\longa*1/2
    \bar "|."
}
...
sextaVoxI = \relative c'' {
    ...
    r2 c1 c2 ~ | c c d d | f f f1 ~ | f2 f e1 | d2.( e4 f2) f | f1 e | 
        d d2. d4 | e\breve | R\breve*3 | r2 c c c | d d c2. c4 | c2 c1 c2 |

    c1 r2 f | f f d1 | c2 c c c | f e e1 | R\breve | c1 c2 c | d c c1 ~ | 
        c r1 | r2 g c c | a1 g | r2 g1 c2 ~ | c4 c a2

    d1 | R\breve | r2 f, bf bf | a2.\melisma bf4 c f, c'2 ~ |
    ...
    d2 c | a1 r1 | R\breve | f'1 e2 d | e1 r1 | r2 c b c ~ | 
        c4( b8[ a] b2) c1 | r1 r2 c | c1 d | c2.( d4 e f g2 ~ | 
        g4 f d e \[ f1 | e) \] 
...
sextaVoxLyricsI = \lyricmode {
    ...
    Al -- le -- lu -- ia.
    Et u -- ni -- ver -- sa mul -- ti -- tu -- do
        Ja -- cob __ ca -- ne -- bat le -- gi -- ti -- me,
    et Da -- vid cum can -- to -- ri -- bus ci -- tha -- ram
        per -- cu -- ti -- e -- bat in do -- mo Do -- mi -- ni,
            in do -- mo Do -- mi -- ni, __
    et lau -- des De -- o,
...
septimaVoxI = \relative c' {
    ...
    % --- page ---
    c1 r1 | r1 r2 g' | e f2.( e8[ d] e2) | f2.( e4 d e f g | a2) f e e | 
        d1 r1 | e1 f2.( c4 | g'2) g1 f2 | f\breve | f1 g |
...
septimaVoxLyricsI = \lyricmode {
    De -- can -- ta -- bat po -- pu -- lus I -- sra -- el. __
    Al -- le -- lu -- ia.
    Et u -- ni -- ver -- sa mul -- ti -- tu -- do
        Ja -- cob ca -- ne -- bat __ le -- gi -- ti -- me, __
    et Da -- vid cum can -- to -- ri -- bus ci -- tha -- ram
