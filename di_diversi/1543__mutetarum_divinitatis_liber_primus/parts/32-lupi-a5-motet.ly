...
cantusXXXII = \relative c'' {
    ...
    g2. f4 f2 ~ | f e f1 ~ | f\breve ~ | f1 r2 f | a2. bf4 c1 |
        ...
        a2.( bf4) c1 | d1. d2 | d1 c2( a ~ | a4 g f1 e2) | f\breve~f\longa*1/2
    \bar "|."
}
...
altusXXXII = \relative c' {
    ...
    e2) f4( g a f | g2 f1 e2) | f1 c | d2 ef1 d2 | c c d1 | r2 c d2. e4 |
        f1 r1 | r2 f, a2. bf4 | 
        c1 r2 c | e2. f4 g2.( f8[ e] | d4 c d2 c1) |
        f, g2 a | bf\breve | r2

    f a2. bf4 | c\breve | a2 f a2.( bf4 |  c1) a\longa*1/4
    \bar "|."
}
...
tenorXXXII = \relative c' {
    ...
    bf1) g2 a ~ | a4 g f1( e2) | f1 r2 f ~ | f a2.( bf4) c2 ~ |
        c( bf4 a g f g2) | f\breve~f\longa*1/2
    \bar "|."
}
...
bassusXXXII = \relative c {
    ...
    e2 | d1 c | R\breve R | g'1 a | f2 bf1 a2 | g1 f | R\breve |
        ...
        f1 c ~ | 
            % vv deleting r1
        c r1 | r2 c e2.( f4 | g1) c,2( f ~ | f e4 d c1) |

    bf1. bf2 | d2.( e4 f1) | c\breve f\breve~f\longa*1/2
    \bar "|."
}
...
quintaParsXXXII = \relative c' {
    ...
    f2 ~ | 
        f2 e f e4 d) | c1 r2 g' ~ | g g e( c | f1 e) | d2 bf d2. e4 |
        f1 r2 c | e2. f4 g1 | r2 c,2.( bf4 a g) | a2. bf4 c\longa*1/4
    \bar "|."
}
