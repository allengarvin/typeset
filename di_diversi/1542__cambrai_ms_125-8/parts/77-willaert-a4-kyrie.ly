...
cantusLXXVII = \relative c' {
    ...
    a2. g4 | f2 e d1) | c r1 | R\breve*2 | r2 g' a2.( b4 | c2) b g( a ~ |
        a g4 f e f g e | f e d c) d1 | r2 c d e | f\melfi e1 d2 | 
        e g1 fs2\melfiEnd | g1 r1 | r2 e d a' ~ | a4( g g2)
    ...
    % --- page ---
    R\breve
    R\breve*2 | g1. e2 | f g e( a ~ | a4 g g2 f4 e d c | b2 c a d ~ | d c1 b2) |
...
altusLXXVII = \relative c' {
    ...
    g2.( a4 | b2) c1( b4 a | b2) c2.( a4) a2 ~ | a4( b c2) b( c) | g c( b4 a g f) | 
        g2 d e4\melfi f g a | b2 c1 a2 ~ | a4 b c1 b2 | a g1 \ficta fs2\unficta\melfiEnd |
    ...
    \bar "||"
    R\breve
    R\breve*2 | r1 c | a2 b c1 ~ | c2( b a1) | g r1 | r1 r2 g ~ | g e g a |
...
tenorLXXVII = \relative c {
    ...
    R\breve*2 | c1 g' | g a | g2.\melfi f4 e d e2 ~ | e d4 c c'2. b4 |
        a2 g1 \ficta f2 | 
        g a1 g4 f\melfiEnd | e\breve | R | r1 c ~ | c2 f1 g2 | a1 g ~ |
        g2( c1 b2) |
    ...
    g1. e2 | f g e\melfi a ~ | a4 g g1 fs2 | g2\melfiEnd e1( d4 c |
...
bassusLXXVII = \relative c {
    ...
    c2 a g1) | c\longa*1/2 
        \bar "||"
    c2.( d4 e2) f ~ | f( e4 d e2) f2 ~ | f4\melfi d g1 fs2\melfiEnd |
    ...
    f2 e4 d) c1 ~ | c r1 | R\breve R\breve*3 | r1 r2 g | c2.( b4 c2) d | e2.( d4 c2 b | 
    ...
    r2 g' ~ | g f e2.( d8[ c] | e4 d) g1\melfi fs2\melfiEnd | g d f g |
