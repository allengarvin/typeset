...
% first part repeats mostly for canto but not for other instruments
    ...
    c2 bf2. a8[ g] a2 | bf1 r2 d | d d c1 ~ | c2 bf a g | a1 r2 bf |
        a g c2. bf4 | a g a2. g4 g2 ~ | g fs g d' |

    d2 d c1 ~ | c2 bf a g | a1 r2 bf | a g c2. bf4 | a g a2. g4 g2 ~ |
        g fs g bf | c d ef1 | d\longa*1/2
    \bar "|."
}
...
altoII = \relative c' {
    ...
    bf2 a1 ~ | a2 a bf1 | r2 g a2. g4 | f e d1 d2 | f g1 f2 | e c d1 |
        c\breve | r2 f f2. g4 | a2 f

    f2 d2 ~ | d4 e f g a1 | g2 f e1 | d r2 a | d c r2 f | f2. e4 d2 f |
        ef2 d f1 | f2. e4

    d4 c d2 | bf' bf a2. a4 | a2 g f e4 d | e1 f2 d ~ | d d ef1 ~ | 
        ef2 d d c | d1 r2 d | bf'

    bf2 a2. a4 | a2 g f e4 d | e1 d2 d ~ | d d ef1 ~ | ef2 d d c |
        d2. c4 bf a g2 | g'2. f4 
...
tenoreII = \relative c' {
  ...
  % vvv guess too faint to read
    ...
    bf2 c | d4 c d e f2 bf, | g bf c1 | d2. c4 bf a bf2 ~ | bf bf2 f f' |
        f d c4 a d2 ~ | d4 \ficta cs8[ b] \unficta cs!2 d

    g,2 | a bf g c2 ~ | c bf4 a bf2 g | a1 bf2 g | bf bf f f' | 
        f d c4 a d2 ~ | d4 \ficta cs8[ b] \unficta cs!2 d g, |

                                 % vvv c2. corrected to d2. (see alto or earlier)
    a bf g c ~ | c bf4 a bf2 g | a d2. c4 bf a | g2 bf c4 g c2 ~ | 
        c b4 a b\longa*1/2
    \bar "|."
}
...
bassoII = \relative c {
    ...
    g2 f | bf1. bf2 | ef, g f1 | bf, r | r1 r2 f' | f g a bf | a1 d,2 g |
        fs g c,1 ~ | c2 f

    g2 ef | d1 g | r1 r2 f | f g a bf | a1 d,2 g | fs g c,1 ~ | c2 f2 g ef |
        d1 g2. f4 | 

    ef2 d  c1 | g'\longa*1/4
    \bar "|."
}
