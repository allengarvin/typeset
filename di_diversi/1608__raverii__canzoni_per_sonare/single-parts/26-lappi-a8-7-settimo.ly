...
\header {
    ...
    subtitle = "La negrona"
    instrument = "26. Canzon vigesimasesta: La negrona (settimo)"
    composer = "Pietro Lappi (c.1575-c.1630)"

    % Things that change per part:
    partname = "Alto II (choir 2, part 2 of 4)"
    instrument = "26. Canzon vigesimasesta: La negrona (settimo)"
...
\book {
    ...
    \bookOutputSuffix "--choir2-2-alto--tr_clef"
    \include "../include/paper-1-part.ly"
    \score {
        \new Voice << 
            \clef "treble"
...
\book {
    \bookOutputName "26-lappi--canzon_vigesimasesta-la_negrona"
    \bookOutputSuffix "--choir2-2-alto--al_clef"
    \include "../include/paper-1-part.ly"
    \score {
        \new Voice << 
            \clef "alto"
