...
groundbassXXIII =  \relative c {
  ...
  \partial 4 r4 	|
  \repeat volta 2 {
    f2. f | c g' | f ~ f | f, ~ f | bf f | c' g2 d4 | f2. f' | f,1. 
  }
  \repeat volta 2 {
    f'2. f | g g,2 c4 | f2. ~ f | f, ~ f | bf f | c' g2 d4 | f2. f' | f,1.
  }
  \repeat volta 2 {
    f'2. f4. g8 a4 | g2. g, | f' ~ f | f, ~ f | bf f | c' g2 d4 | f2. ~ f | f1.
  }
  \repeat volta 2 {
    f'2. f4. g8 a4 | g2. g, | f ~ f | f ~ f | bf f | c' g2 d4 | f2. ~ f | f1.
  }
  \repeat volta 2 {
    f'2. f4. g8 a4 | g2. d2 e4 | f2. f, | f' ~ f | bf, f | g ~ g | f ~ f | f1.
  }
  \repeat volta 2 {
    f'2. ~ f | c g | f ~ f | f' ~ f | bf, f' | f, bf | f g | f' f, | 
  }
  \repeat volta 2 {
    f'2. ~ f | c g' | f ~ f | f, ~ f | bf f | c'2. g2 d4 | f2. ~ f | f1. |
  }
  \repeat volta 2 {
    f2. f' | c g | f bf | f ~ f | g f | c' g | f ~ f | f1.
  }
  \repeat volta 2 {
        f'2. ~ f | c g' | f ~ f | f, ~ f | bf f | c' g | f ~ f | f1.
  }
