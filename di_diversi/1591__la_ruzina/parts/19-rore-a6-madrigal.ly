...
% ch'io dico un altra volta, «O me felice;
% o me felice più d'ogni altro quanto,
% più d'ogni altr'è costei leggiadra e bella.»
% 
...
cantoXIX = \relative c'' {
    ...
    f\breve | bf,1 a2 d ~ | d f e a, ~ | a4 a a2 bf a | d4 c d4( e f g |
    ...
    a2 a | g f bf1 | r2 a bf1 | a2 g f f2.( e8[ d] e2)
        f\longa*1/2
    \bar "||"
...
%    Ch'io di -- co~u -- n'al -- tra vol -- ta, O me % fe -- li -- ce;
%    O me fe -- li -- ce più d'o -- gn'al -- tro quan -- to,
%    Più d'o -- gn'al -- tr'è co -- stei leg -- gia -- dr'e bel -- la,
%            e bel -- la,
%        O me % fe -- li -- ce;
...
altoXIX = \relative c' {
    ...
    g2 g r2 a | g e f e | d c e1 | g2 e g1 ~ | g2 c, f d | f1 e | e e2 e |
        e1
    ...
    r1 | R\breve | r1 e | f2 d2. d4 f2 | e e f1 ~ | f2 g g1 | g1. g2 |
        ef1 ef | c2 f1 e2 | e1 r2 f | 

    f,2. f4 f2 f | f1 f | r2 f f'2. f4 | f2 f 1 | f g ~ | g2 g1 e2 | g1 fs |
        g\breve | f1. d2 | f1

    e2 e ~ | e e e1 | f d | d2 f1 f2 | a\breve | f1 g2 g ~ | g4( f e d c1) |
        d2 d2.( c4 d e |

    f2. e8[ d] c2) c | g'1 a | r1 g | g1. e2 | g1 fs | g\breve | f1. d2 |
        f1 e2 e ~ | e e e1 | f d | 

    d2 f1 f2 | a\breve | f1 g2 g ~ | g4( f e d c1) | d2 d2.( c4 d e |
        f2) f c\breve
        c\longa*1/2 
    \bar "|."
}
...
tenoreXIX = \relative c' {
    ...
    s1*0 #(if *is-parts* #{<> ^\markup { \italic { "Prima parte" } } #})
    r2 g g1 | c a a f ~ | f d g1 | c,2 f2.( g4 a bf | c2) c 
    ...
    g1 d | R\breve*2 | r1 f | g2 a2. a4 c2 | b c r2 c | bf a2. a4 g2 | g g f1 |
        g2 a
...
bassoXIX = \relative c {
    ...
    bf1 f | R\breve*5 | r1 f | g2 a2. a4 c2 | b c r1 | R\breve | 
    ...
    r2 bf1 bf' ~ | bf bf g1 | d2 f f f | c d bf1 | r2 f' bf,4( c d e |
        f2) c d1 | c
...
quintoXIX = \relative c' {
    ...
    s1*0 #(if *is-parts* #{<> ^\markup { \italic { "Seconda parte" } } #})
    r1 d'1 | e2 e d2. c4 | d2 f d d | d1 a2 c | bf2. a4 

    g2 c | bf1 a2 c | d c r1 | R\breve*3 | r2 bf c1 | bf2 d2. d4 d2 | 
    ...
    s1*0 #(if *is-parts* #{<> ^\markup { \italic { "Terza parte" } } #})
    R\breve*18 | r2 f, f f | g a f1 | 

    r2 c' f,4( g a bf | c2) g a4( g a bf | c1) f, | r2 f f f | 

    g2 a f1 | r2 c' f,4( g a bf | c2) g a1 | a\longa*1/2
    \bar "||"
    s1*0 #(if *is-parts* #{<> ^\markup { \italic { "Quarta e ultima parte" } } #})
...
%    Ri -- mar -- rà la tua fe -- de,
    ...
    Più d'o -- gn'al -- tr'è __ co -- stei leg -- gia -- dr'e bel -- la,
        ...
        O me __ % fe -- li -- ce;
    O me fe -- li -- ce più d'o -- gn'al -- tro quan -- to,
    Più d'o -- gn'al -- tr'è co -- stei __ leg -- gia -- dr'e bel -- la,
            e bel -- la.
% 
}
