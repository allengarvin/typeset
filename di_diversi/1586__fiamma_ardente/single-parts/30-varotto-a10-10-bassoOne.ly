...
\header {
    ...
    subtitle = "Spagnuolo"
    instrument = "Dialogo a dieci:  (bassoOne)"
    headerspace = \markup { \vspace #2 }

    % Things that change per part:
    partname = "Basso II (part 10 of 10)"
    instrument = "Dialogo a dieci:  (bassoOne)"
...
\book {
    ...
    \bookOutputSuffix "--10-basso_2--tr8_clef"
    \include "../include/paper-1-part.ly"
    \score {
        \new Voice << 
            \clef "treble_8"
...
\book {
    \bookOutputName "30-varotto--dialogo_a_dieci-"
    \bookOutputSuffix "--10-basso_2--al_clef"
    \include "../include/paper-1-part.ly"
    \score {
        \new Voice << 
            \clef "alto"
...
\book {
    \bookOutputName "30-varotto--dialogo_a_dieci-"
    \bookOutputSuffix "--10-basso_2--bs_clef"
    \include "../include/paper-1-part.ly"
    \score {
        \new Voice << 
            \clef "bass"
