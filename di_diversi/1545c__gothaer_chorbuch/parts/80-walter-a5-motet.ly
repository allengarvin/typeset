...
discantusLXXXincipit = \relative c' {
    \time 2/2
    \clef "petrucci-c1"
    \key f \major
...
bassusTwoLyricsLXXX = \lyricmode {
}

vagansLXXXincipit = \relative c {
    \time 2/2
    \clef "petrucci-f3"
    \key f \major
...
discantusLXXXincipitVoice = <<
    \new MensuralVoice <<
        { s1 \noBreak }
        \discantusLXXXincipit
    >>
>>
