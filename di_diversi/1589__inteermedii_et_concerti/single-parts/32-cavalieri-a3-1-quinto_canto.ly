...
\header {
    ...
    instrument = "O che nuovo miracolo (canto [ballo] e quinto [risposta])"
    ...
    partname = "Canto (ballo) e Quinto (risposta) (parts 1/5 e 1/3)"
...
\book {
    ...
    \bookOutputSuffix "--1-canto_e_quinto--tr_clef"
    \include "../include/paper-1-part.ly"
    \score {
        \new Voice << 
