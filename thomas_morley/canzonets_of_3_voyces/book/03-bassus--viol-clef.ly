...
\book {
    ...
    \score {
        \new Voice = "Bassus" << \clef alto \global \bassusI >>
    ...
    \pageBreak
    \score {
        \new Voice = "Bassus" << \clef alto \global \bassusII >>
    ...
    \score {
        \new Voice = "Bassus" << \clef alto \global \bassusIII >>
    ...
    \pageBreak
    \score {
        \new Voice = "Bassus" << \clef alto \global \bassusIV >>
    ...
    \pageBreak
    \score {
        \new Voice = "Bassus" << \clef alto \global \bassusV >>
    ...
    \pageBreak
    \score {
        \new Voice = "Bassus" << \clef alto \global \bassusVI >>
    ...
    \pageBreak
    \score {
        \new Voice = "Bassus" << \clef alto \global \bassusVIII >>
    ...
    \pageBreak
    \score {
        \new Voice = "Bassus" << \clef alto \global \bassusVII >>
    ...
    \score {
        \new Voice = "Bassus" << \clef bass \global \bassusXI >>
    ...
    \pageBreak
    \score {
        \new Voice = "Bassus" << \clef bass \global \bassusIX >>
    ...
    \score {
        \new Voice = "Bassus" << \clef bass \global \bassusX >>
    ...
    \score {
        \new Voice = "Bassus" << \clef alto \global \bassusXII >>
    ...
    \pageBreak
    \score {
        \new Voice = "Bassus" << \clef alto \global \bassusXIII >>
    ...
    \pageBreak
    \score {
        \new Voice = "Bassus" << \clef bass \global \bassusXIV >>
    ...
    \score {
        \new Voice = "Bassus" << \clef alto \global \bassusXV >>
    ...
    \pageBreak
    \score {
        \new Voice = "Bassus" << \clef alto \global \bassusXVI >>
    ...
    \pageBreak
    \score {
        \new Voice = "Bassus" << \clef alto \global \bassusXVII >>
    ...
    \pageBreak
    \score {
        \new Voice = "Bassus" << \clef alto \global \bassusXIX >>
            \addlyrics { \bassusLyricsModernXIX }
        \include "../include/vocal-layout-parts-barring.ly"
        \header {
            piece = "XIX. Say Dear Will You Not"
        }
    }
    \score {
        \new Voice = "Bassus" << \clef alto \global \bassusXX >>
    ...
    \pageBreak
    \score {
        \new Voice = "Bassus" << \clef alto \global \bassusXVIII >>
