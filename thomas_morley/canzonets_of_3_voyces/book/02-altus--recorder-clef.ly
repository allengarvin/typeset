...
\book {
    ...
    \pageBreak
    \score {
        \new Voice = "Altus" << \clef "treble_8" \global \altusVIII >>
    ...
    \pageBreak
    \score {
        \new Voice = "Altus" << \clef "treble_8" \global \altusIX >>
    ...
    \score {
        \new Voice = "Altus" << \clef "treble_8" \global \altusX >>
    ...
    \pageBreak
    \score {
        \new Voice = "Altus" << \global \altusXIV >>
    ...
    \pageBreak
    \score {
        \new Voice = "Altus" << \clef treble \global \altusXIX >>
