...
cantusXIX = \relative c'' {
    ...
    \fourTwoCommonTime a2 c d4 e f d | e2 d4 c2 b4 c g | a bf c4. c8 bf4 a g2 | a

    r4 c d e f d | \invisibleTime \time 6/2 
        e2 \raisedSixTwoTime c b4 b c1 b2 | 
...
cantusLyricsXIX = \lyricmode {
    Say, deere, will you not, 
    will you not have me, 
    here then, heere take your kisse 
        you gave mee, 
    Say, deere, will you not have mee? 
    heere then that kisse, 
    that kisse take you gave, 
        you _ _ _ gave mee, 

    You else wher par- haps thinck to be- stow it, 
    and I as loth would bee to owe _ it. 
    and I as loth would be to owe it.
    and I as loth a- gaine would be to owe _ it. 

    Or if you will not so take, 
    or if you will not so take the thing, once _ given: 
    let mee, kisse you, 
    let mee I say kisse you, kisse you: 
    and so wee shall bee e- ven.

    Or if you will not so take, 
    or if you will not so take the thing, 
    once _ given, let mee kisse you, 
    let mee I say kisse you, kisse you, 
    and so wee shall bee e -- ven.
}
...
altusXIX = \relative c' {
    ...
    g g f | f e1 | \fourTwoCommonTime f2 r4 f2 g4 a bf c2 bf4 g a f g e f g

    a2 g4 f2 e4 f bf2 a g4 a bf | \invisibleTime \time 6/2
        c\raisedSixTwoTime c, e f g2 e d1 | 
...
altusLyricsXIX = \lyricmode {
    Say, deere, will you not have mee? 
    will you not have mee? 
    heere then your kisse, 
    your kisse you gave _ mee, 
    Say, deere, will you not have mee? 
    heere then that kisse, 
    that kisse, heere you _ gave mee, 
        you _ gave _ mee, 

    You else wher par- haps think to be- stow it, 
    and I as loth am, 
    I as loth a- gain as loth wold bee to owe _ it, 
    and I as loth a- gaine, 
    would be, would bee to owe it. 

    Or if you will not, you will not the thing once _ given: 
    or if you will not the thing once _ _ given: 
    let mee, kisse you, 
    let mee, kisse you, 
    kisse I say kisse you, 
    and so wee shall _ bee e- ven. 

    Or if you wil not, 
    you wil not the thing once _ given: 
    or if you will not the thing once _ _ given, 
    Let mee kisse you, 
    let mee kisse you, 
    kisse I say kisse you, 
...
bassusXIX = \relative c {
    ...
    r2 r4 f, g a bf c | d bf8[ c] d[ e] f2 e4 d2 | \invisibleTime \time 6/2
        c\raisedSixTwoTime c g\breve | \invisibleTime \time 4/2 c2 c f4. f8
...
bassusLyricsXIX = \lyricmode {
    Say, deere, will you not have mee? 
    Say, deere will you not have mee? 
    wil you not have mee? 
    here then take your kisse you gave mee, 
    that kisse you once gave mee; 
    here then that kisse, that kisse, 
    heere a- gaine the kisse, 
    the kisse you gave, you gave mee, 

    You else wher par- haps would _ _ _ be- stow it, 
    and I as loth a- gaine 
    and I as loth a- gaine, 
    I would be as loth to owe it, to ow it. 

    Or if you will not, 
    you will not the thing once given: 
    or if you will not so take the thing once _ given; 
    let mee, kisse you, kisse you, 
    let mee I say kisse you and so we shal bee e- ven. 
    ...
    Let mee kisse you, kisse you,   
    let mee I say kisse you, 
    and so wee shall be e -- ven. 
}
...
bassusLyricsModernXIX = \lyricmode {
    ...
    You else where per- haps would _ _ _ be- stow it, 
    and I as loth a- gain 
    and I as loth a- gain, 
