...
cantusXX = \relative c' {
    ...
    g8.[ a16] bf4 f8.[ g16 a8 bf] c4 g8.[ a16 bf8 c] d4 |
        ...
        c\raisedSixTwoTime c d bf c2 a g g | \invisibleTime \time 4/2
        a\longa*1/2
    \bar "|."
}

cantusLyricsXX = \lyricmode {
    A- rise, get up, my deere, 
    a- rise, my deere, 
    make hast to be gone thee, 

    lo where the bride, 
    lo wher the bride faire Daph- ne, bright, 
    where the bride faire Daph- ne bright 
        tar- ries on _ thee. 

    Harke, o, harke you mer- ry mer- ry may- dens squeal- ing: 
    spice cake sopps in wyne are now dea - ling, 
        spice cake sops in wyne, sops in wyne, 
    sops in wyne are a __ deal- ing, 
    spice cake sops in wine sops in wyne are now a deal- ing, 

    Runne then run a pace, 
        run a pace, 
    run then run a pace then, 
    so get a bride lace, 
    and a guilt Rose- mar- y branch 
    the while yet ther is cat- ching, 
    and then hould fast for feare of old snatch- ing. 

    A- las my dear why weep she, 
    O feare not, feare not that, 
        dear love dear love, the next day keep _ wee, 

    List hark you Min- strells, 
    how fine they firck it? 
    and how the maids irck it, 
    with Kate and Will, Tom and Gill, 
    now a skip, then a trip, 
    fine- ly set a loft, 
    there a- gaine as oft, 
    o bless- ed hol- ly - day, 
    List harck you Min- strells, 
    how fine they firck it? 
    and how the maides irck it, 
    with Kate and Will, Tom and Gill, 
    now a skip then a trip, 
    fine- ly set a loft 
        ther a- gain as oft, 
    hey ho bless- ed hol- ly, hol- ly day. 
}
...
altusXX = \relative c' {
    ...
    c2 ~ | c4 b8[ a] b2 d2. bf4 | a g f g8[ a]
    ...
    e8[ f] g4 d8[ e] f4 c8[ d e f] g4 d8[ e] | \invisibleTime \time 6/2
        f[ \raisedSixTwoTime g] a4 f g2 f4 f2. e8[ d] e4 e |
        \invisibleTime \time 4/2 f\longa*1/2
    \bar "|."
}

altusLyricsXX = \lyricmode {
    A- rise, get upp my deere, 
    get upp my deere, "(what" I say) rise, my deere, 
    make hast and be gon bee gon thee, 

    lo wher the bride, 
    lo wher the bride, 
        the bride, 
    wher the bride faire Daph- ne bright ta- ries 
    all this while on _ _ _ thee. 

    Harck, o, hark you mer- y, mer- y, mer- y, mer- y maid- ens squeal- ing: 
    spice cake sops in wyne, sops in wine are deal- ing, 
    spice cake sops in wyne, sops in wyne are dea- ling, 
    spice cake sops in wine, o fine, spice cake sops in wine, 
        o fine, are a dea - ling, 

    Runne then, run a pace, run a pace, run a pace, 
        Run then, run a pace, a pace, 
    and get, o get a bride _ lace, 
    and a guilt Rose- mar- y branch the while yet ther is cat- ching, 
    and then hould fast for feare of old snatch- ing. 

    A- las my deer, o why weep _ _ she, 
    O feare not, fear not that, deer love, the next day keep wee. 
    Hark list you min- strells, how fine they firck it? 
        firck it? 
    and see how the maids jerck it, jerck it, 
    with Kate and Wil, and Gil, 
    now a trip, then a skip, fine- ly set a loft, 
    hey ho fine brave ho- ly day. 
    Harck list you Min- strels, 
    how fine they firck it, firck it? 
    and see how the mayds jerk it, jerk it? 
    with Kate and Wil, and Gill, 
    now a trip, then a skip, 
    fine- ly set a loft, ther a- gain as oft, 
    o fine brave hol - _ _ ly day.
}
...
altusLyricsModernXX = \lyricmode {
    ...
    Hark, o, hark you mer- ry, mer- ry, mer- ry, mer- ry maid- ens squeal- ing: 
    ...
    Run then, run a pace, run a pace, run a pace, 
        Run then, run a pace, a pace, 
    and get, o get a bride _ lace, 
    and a gilt Rose- mar- y branch the while yet there is cat- ching, 
    and then hold fast for fear of old snatch- ing. 

    A- las my dear, o why weep _ _ she, 
...
bassusXX = \relative c {
    ...
    g8.[ a16] bf4 | \invisibleTime \time 6/2
        a\raisedSixTwoTime f bf g a2. bf4 c2 c | \invisibleTime \time 4/2
        f,\longa*1/2
...
bassusLyricsXX = \lyricmode {
    A- rise, get up, my deere, 
    get up, my deere love, 
    rise make hast be- gone _ thee, 
    lo wher the bride, 
        lo wher the bride 
    fayre Daph- ne bright, 
    wher the bride faire Daph- ne bright 
        still stayes on thee. 

    Hark, o hark you mer- y mer- y wan- ton maid- ens sque- ling: 
    spice cake sops in wine, spice cakes are a deal- ing; 
    spice cakes sops in wine, sops in wine are a deal- ing, 
        are a deal- ing, 

    Run then run a pace, 
    run a pace then, run then run a pace, 
    a _ pace and get a bride lace; 
    and a guilt Rose- mar- y brance 
    the while yet ther is catch- ing, 
    and then hould fast for feare of old snatch- ing. 

    A- las, my love, my love, 
        why weep _ ye? 
    O feare not, fear not that, deere love, 
        the next day keep wee; 
    ...
    List hark you Min- strells, 
    how fine they firck it? 
    and how the maydes jerk it? 
    with Kate and Will, Tom and Gill, 
    hey ho brave, now a skip, there a trip, 
    fine- ly sett a loft, 
    all for fayre Daph- nes, 
    Daph- nes, wed- ding, wed- ding day. 
}
