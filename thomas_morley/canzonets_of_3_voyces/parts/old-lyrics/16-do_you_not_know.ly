...
% Cantus notes: checked (but see note about c naturals)
cantusXVI = \relative c' {
    ...
    cs d e2 cs r4 e | % check the following c2 by playing and looking at score: 
        c4. d8 e4 f e d cs d | e d2 cs4 d2 r |

    r2 d4 d8[ d] c4 a bf2 | a g f f'4 f8[ f] | e4 c d2 cs2. cs4 |

    d2 e f e | d1 cs4 e \ficta cs!4.\unficta d8 | e4 f e d cs d e2 |

    cs r4 e c4. d8 e4 f | %<- check c4. (see above) maybe c#?
...
cantusLyricsXVI = \lyricmode {
    ...
    doe you not know, doe you not know 
    how Love lost first his see- ing? 

    Be- cause with mee, 
    with mee once ga- zing, 
    on those, on those faire eies, 
    wher all powres have their bee- ing, 
    wher all powres have their bee- ing, 
    wher all powres have their _ bee- ing, 
    wher all powres have their be- ing: 

    she with hir bew- ty bla- zing, bla- zing, 
    shee with hir bew- ty bla- zing, 
    which death might have re- vi- ved, 
    him of his sight, and mee of hart de- pri- ved: 
    him of his sight, and mee of hart de - pri - ved. 
    She with hir bew- ty blaz- ing, bla- zing, 
    she with hir bew- ty bla- zing, 
    which death might have re- vi- ved, 
    him of his sight and mee of hart de- pri- ved, 
    him of his sight and mee of hart de pri - _ ved.
...
cantusLyricsModernXVI = \lyricmode {
    ...
    where all powers have their be- ing, 
    where all powers have their _ be- ing, 
    where all powers have their be- ing: 
    ...
    which death might have re- vi- ved, 
    him of his sight and me of heart de- pri- ved, 
    him of his sight and me of heart de- pri - _ ved.
}
...
altusLyricsXVI = \lyricmode {
    Doe you not know how Love, 
    how love lost first his see- ing? 
    do you not know, doe you not _ know 
    how Love lost first his see- ing? 

    Be- cause with me, 
    Be- cause with me once ga- zing, 
    on those, on those faire eyes, 
    wher all powres have their bee- ing, 
    wher all powres have their bee - ing, 
    where all powres have ther bee- ing 
    wher all powres have their bee - ing, 

    shee with hir bew- ty bla- zing, 
    shee with hir bew- ty blaz- ing, 
    she with hir bew- ty bla- zing, 
    which death might have re- vi - _ _ ved, 
    him of his sight, and mee of hart de- pri- ved, 
    him of his sight and mee of hart de- pri- ved, 
    She with hir bew- ty bla- zing, 
    she with hir bew- ty bla- zing, 
...
altusLyricsModernXVI = \lyricmode {
    ...
    how love lost first his see- ing? 
    do you not know, do you not _ know 
    how Love lost first his see- ing? 
...
bassusLyricsXVI = \lyricmode {
    ...
    on those faire eyes, 
        wher all powres, 
    all powres have their bee - _ ing, 
        where all powres, 
    all powres have their bee- ing: 
...
bassusLyricsModernXVI = \lyricmode {
    ...
    on those fair eyes, 
        where all powers, 
    all powers have their be - _ ing, 
        where all powers, 
