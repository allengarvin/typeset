...
altusXII = \relative c'' {
    ...
    a4 ~ | a gs4 a a g c b g | a c2 b8[ a] gs4 gs c4. c8 |

    b4. a16[ g] a4 b c a4. gs16[ fs] gs4 | a4. b8 c4 c b4. c8 a4. b8 |

    gs4 a a gs a a c4. c8 | b4 b4. a8 a2 gs4 a e ~ | e e2 d4 

    e b c d | e c b2 a4 a' g f | e2. fs4 gs a2 gs4  | a\longa*1/2
    \bar "|."
}
...
altusLyricsModernXII = \lyricmode {
    ...
    ah can these trick --  ling _ tears of mine, 
        of mine, of mine, 
    not pro --  cure __ _ _  love? 

    What shep --  herd e - _ _  ver yet killed __ _ _  a Nymph
...
bassusXII = \relative c' {
    ...
    r4 a e' d8[ c] | \invisibleTime \time 6/2 
        ...
        b4 c d e a,8[ b c d] e4 c g' e f2 |
    ...
    g' e d2 | c2. a4 d4. d8 c4. \melisma b16[ a] | 
        b4 \melismaEnd b a f' e c

    g' e | d e f2 e r4 a, | 
        e'4. e8 d4. d8 c4. \melisma b16[ a] b4 \melismaEnd b |

    a f' e c g'4. e8 f4. d8 | e4 f e2 a,2. a4 |

    d4. d8 c4. \melisma b16[ a] b4 \melismaEnd b a a | g e f2 e1 |
        r2 r4 e f2 g | a2. a4 e1 | 
        a\longa*1/2
    \bar "|."
}
