...
cantusXVII = \relative c' {
    ...
    r4 c2 b4 | c g bf!2 a4 g4. f8 f4 ~ | f e8[ d] e2 f4 f' e d4 ~ |
        d8[ c8]

    c2 b4 c1 | c4 bf a g f2 f'4 e | d c b c d2 g4 f | e d

    c2 c4 bf a g | f2 f'4 e d c b e | d c b e d c2 b4 |

    c1 g4 a bf2 ~ | bf4 a4 f g a2 g | f4 e8[ f] g4 f e f
...
cantusLyricsModernXVII = \lyricmode {
    ...
    where art, where art thou, where art __ _ _ thou? 
...
altusXVII = \relative c' {
    ...
    e d c4 ef d c | bf1 a2 g4 f4 ~ | f e4 d2 e1 | r2 c'4 bf 

    a g f2 | f'4 e d c b c d2 | g4 f e d c2 c4 bf | a g f2 

    f'4 e d c | b e d c b e d2 | e c4 d ef2 d2 ~ | d4 c4

    a bf c2. bf4 | a g8[ a] bf4 a g a g2 | a f a r4 f |
    ...
    a g4 f e2 a ~ | \invisibleTime \time 6/2 
        ...
        a2 g2. f4 f1 e2 | \invisibleTime \time 4/2 f\longa*1/2
    \bar "|."
}
...
altusLyricsModernXVII = \lyricmode {
    ...
    where thy true love true, 
    see where thy true love true 
    his heart to keep, to __ _ keep, to keep hath brought _ thee.
}
...
bassusXVII = \relative c {
    ...
    r4 g c c bf a | g1 f8[ g a bf] c4 d | b c

    g2 c2 c4 bf | a g f2 f'4 e d c | b c g2 g'4 f e d | c2

    c4 bf a g f2 | f'4 e d c b c g c | g1. g2 | c1 r2 g4 a  |

    bf c d2 c1 | d2 bf c1 |
        f,\breve | R\breve | f1 a2 r4 f |
        c'1 f,2 r4 f' |
