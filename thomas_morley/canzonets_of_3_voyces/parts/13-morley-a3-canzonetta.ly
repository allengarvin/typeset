...
cantusXIII = \relative c'' {
    ...
    fs4 d fs fs | e1 fs2 r4 a | d4. a8 bf4. c8 a4 g a2 | b bf a a |
    ...
    bf4 bf ef4. d8 c4 c d4. c8 | \invisibleTime \time 6/2 
        ...
        bf4 bf c1 bf2 a1 | \invisibleTime \time 4/2 
        b\longa*1/2
    \bar "|."
}
...
cantusLyricsModernXIII = \lyricmode {
    ...
    O grief, __ o grief, a -- las, 
    O who may a -- bide __ _ it? 
    Hold, hold out 
...
altusLyricsModernXIII = \lyricmode {
    ...
    O grief, __ o grief who may a -- bide __ _ it? 
        O who may a -- bide it? 
    hold, hold out, break not heart, 
        but hide it, 
    O break not hold out, break not, hold out heart, 
        hold hold O hold it, 
        O hold, O hold, O hold and hide __ _ _ _ it, 
    o break not heart, but hide __ _ _ _ it 
...
bassusXIII = \relative c' {
    ...
    b b c2. bf4 | \invisibleTime \time 6/2 
        s1*0 #(if *is-parts* #{<>\raisedSixTwoTime #})
        a1 g2 f ef1 |
    ...
    \invisibleTime \time 6/2 s1*0 #(if *is-parts* #{<>\raisedSixTwoTime #})
    ef4. d8 c4 c d\breve | \invisibleTime \time 4/2 
        g,\longa*1/2
    \bar "|."
}
