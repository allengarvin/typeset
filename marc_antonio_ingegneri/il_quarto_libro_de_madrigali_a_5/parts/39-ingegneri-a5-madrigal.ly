...
cantoXXXIX = \relative c'' {
    ...
    a1 f g | a2( b c b4 a g1) | c b\breve | a1 a c | d e1.( d4 c |
        b1. a2 g1) | a a\breve | }
        \fourTwoCutTime 
        a1 r1 | R\breve R | \fourTwoCutTime
        R\breve*3 |

    \fourTwoCutTime r1 c2 c4 c | b2 a a2. a4 | 
        b c d2 cs e | c! d e e | 
    ...
    a1 a f | d1. d2 d1 | d'\breve\melfi cs1\melfiEnd | d\breve. } |
        \fourTwoCutTime r2 d2. d4 a2 ~ | a c1 g2 | c b c1 ~ | c2 b a2.( g4 |
        f1) e | \fourTwoCutTime \times 2/3 { f\breve g1 | a f g | a a1. b2 | 

    c1. a1 b2 | c\breve d1 | 
        \ficta ef\unficta d\breve | d\breve\melfi cs1\melfiEnd |
        d\breve. } | \fourTwoCutTime R\breve | a2. a4 e1 | g e2 a ~ |
        a g c2. b4 | a1 a | 
        \fourTwoCutTime \times 2/3 { a1. b2 c1 ~ | c2 a1 b2 c1 |
        r1 f,\breve | g1 a f | 
...
altoXXXIX = \relative c' {
    ...
    cs1 d e | f\breve e1 | a\breve\melfi gs1\melfiEnd |
        ...
        g2( a b c d1) | f e\breve | } \fourTwoCutTime
        d2 f f4 f e2 ~ | e d1 c2 ~ | c4 c d e 

    f2 e | \fourTwoCutTime \times 2/3 { a1 f g | \colorBr a\breve \colorBrBegin g1 ~ | 
        g e\breve\colorBrEnd } | \fourTwoCutTime d2 f f4 f e2 | d d1 cs4 d ~ |
    ...
    e2 e r2 | f d4 d g e e2 | e r4 a2 f a4 | g e g1 g2 |
        \fourTwoCutTime \times 2/3 { \colorBr g1\colorBrBegin e1 f ~ | f2 f d\breve\colorBrEnd |
        d\breve\melfi cs1\melfiEnd | d\breve d1 | f1 f1. f2 | g1 e\breve | 
        fs\breve. | }

    \fourTwoCutTime g2. g4 d2 f ~ | f e c2.( d4 | e2) d c e | 
        e2.( d4 c d e2 ~ | e4 d8[ c] d2) cs1 | \fourTwoCutTime
        \times 2/3 { 
        d\breve e1 | f\breve e1 | c\breve d1 | e c d | e f\breve |
        g\breve. | f1 e\breve | fs\breve. | }

    \fourTwoCutTime g2. g4 d2 f ~ | f e c2.( d4 | e2) d c e | e2.( d4 c d e2 ~|
        e4 d8[ c] d2) cs1 | \fourTwoCutTime \times 2/3 { 
        d\breve e1 | f\breve e1 | c\breve d1 | e c d | e f\breve |
...
tenoreXXXIX = \relative c' {
    ...
    a1 d c | f,2( g a b c1) | a e'\breve | a, r1 | r1 e e' ~ | 
        e d b | a a\breve } | \fourTwoCutTime a1 c2 c4 c | b1 a2 a | g4 a

    b c2( b4) c2 | \fourTwoCutTime \times 2/3 { f1 d e | f\breve e1 | d\breve( cs1) | }
        \fourTwoCutTime d1 r1 | R\breve*3 | 
    ...
    \fourTwoCutTime \times 2/3 {
        \colorBr c\breve \colorBrBegin a1 ~ | a bf1. bf2 |
        g1 a\breve\colorBrEnd | d,\breve f1 | a d,1. d2 | d1 a'\breve |
        a\breve. } | \fourTwoCutTime r1 r2 d2 ~ | d4 d a1 c2 ~ | c g a1 |
        e f2 c | d1 a' | \fourTwoCutTime R\breve | \times 2/3 { c1 d e | 

    a,1. g2 f1 | e f\breve | e1 a\breve | g\breve g1 | a\breve. | a | }
        \fourTwoCutTime r1 r2 d ~ | d4 d a1 c2 ~ | c g a1 | e f2 c | d1 a' |
        \fourTwoCutTime | R\breve | \times 2/3 { c1 d e | a,1. g2 f1 | e f\breve |
...
bassoXXXIX = \relative c {
    ...
    R\breve*3 \times 2/3 { r1 a a' | g c,1.( d2 | e f g\breve) | d1 a\breve | }
        \fourTwoCutTime d1 a'2 a4 a | g1 f2 f | e4 f2 e4 d2 c | 
        \fourTwoCutTime \times 2/3 { d1 d c | 

    f2( g a b c1) | g a\breve  }  \fourTwoCutTime d,1 r1 | R\breve*4 |
                  % vv removing cs4
        r4 a a a d2 c4 d ~ | d e f a g2 f | r2 a g4 c, f2 | e d c r2 | r2 e 

    f4 g a2 | d, e a, f' ~ | f4 d d g2 a4 e2 ~ | e a, f' d4 d | g4 a g1 c,2 |
        \fourTwoCutTime R\breve*2 R\breve | 
        \times 2/3 { 
        \colorBr f\breve\colorBrBegin d1 ~ d bf1. bf2\colorBrEnd |
        g1 a\breve | d\breve. | } \fourTwoCutTime R\breve*5 |

    \fourTwoCutTime \times 2/3 { d\breve c1 | f d c | f\breve d1 | c f d | c f\breve | 
        c1 g\breve | d'1 a\breve | d\breve. } |
        \fourTwoCutTime R\breve*2 R\breve*3|
        \fourTwoCutTime \times 2/3 { d\breve c1 | f d c | f\breve d1 | c f d
...
quintoXXXIX = \relative c'' {
    ...
    R\breve*3 | \times 2/3 { c\breve a1 | b c1.( b4 a | g1. a2 b1) | 
        d1 cs\breve } | \fourTwoCutTime 
        d1 r1 | R\breve R | \fourTwoCutTime 
        R\breve*3 | \fourTwoCutTime r2 a a4 a g2 ~ | 
        g f2 f e4 fs | 
    ...
    b4( a2 gs4) a1 | R\breve | r2 c a4 a d4. c8 | b4( c d1) e2 |
        ...
        bf1 a\breve | a\breve. } | 
        \fourTwoCutTime R\breve | a2. a4 e1 | 
    ...
    g1 e2 a2 ~ | a g c2. b4 | a1 a | 
        ...
        a\breve. }
        \fourTwoCutTime r2 d2. d4 a2 ~ | a c1 g2 | 

    c2 b c1 ~ | c2 b a2.( g4 | f1) e |
        \fourTwoCutTime  \times 2/3 { f\breve g1 | a f g | a a1. b2 | 
