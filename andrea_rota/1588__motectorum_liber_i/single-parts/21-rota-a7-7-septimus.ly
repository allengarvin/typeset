...
\header {
    ...
    subtitle = ""
    subsubtitle = ""
    instrument = "In dedicatione templi:  (septimus)"
    headerspace = \markup { \vspace #2 }
    shorttitle = "in_dedicatione_templi"
    shortcomp = "rota"

    % Things that change per part:
    partname = "Septimus (Choir II (low), part 3 of 4)"
    instrument = "In dedicatione templi:  (septimus)"
...
\book {
    ...
    \bookOutputSuffix "--choir_2-3-septimus--tr8_clef"
    \include "../include/paper-1-part.ly"
    \score {
        \new Voice << 
            \clef "treble_8"
...
\book {
    \bookOutputName "21-rota--in_dedicatione_templi-"
    \bookOutputSuffix "--choir_2-3-septimus--al_clef"
    \include "../include/paper-1-part.ly"
    \score {
        \new Voice << 
            \clef "alto"
