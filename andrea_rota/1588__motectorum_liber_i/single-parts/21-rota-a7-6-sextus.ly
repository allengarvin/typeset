...
\header {
    ...
    subtitle = ""
    subsubtitle = ""
    instrument = "In dedicatione templi:  (sextus)"
    headerspace = \markup { \vspace #2 }
    shorttitle = "in_dedicatione_templi"
    shortcomp = "rota"

    % Things that change per part:
    partname = "Sextus (Choir II (low), part 1 of 4)"
    instrument = "In dedicatione templi:  (sextus)"
...
\book {
    ...
    \bookOutputSuffix "--choir_2-1-sextus--tr_clef"
    \include "../include/paper-1-part.ly"
    \score {
        \new Voice << 
            \clef "treble"
...
\book {
    \bookOutputName "21-rota--in_dedicatione_templi-"
    \bookOutputSuffix "--choir_2-1-sextus--al_clef"
    \include "../include/paper-1-part.ly"
    \score {
        \new Voice << 
            \clef "alto"
