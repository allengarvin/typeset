...
\header {
    ...
    subtitle = ""
    subsubtitle = ""
    instrument = "In dedicatione templi:  (tenor)"
    headerspace = \markup { \vspace #2 }
    shorttitle = "in_dedicatione_templi"
    shortcomp = "rota"

    % Things that change per part:
    partname = "Tenor (Choir I (high), part 3 of 3)"
    instrument = "In dedicatione templi:  (tenor)"
...
\book {
    ...
    \bookOutputSuffix "--choir_1-3-tenor--tr8_clef"
    \include "../include/paper-1-part.ly"
    \score {
        \new Voice << 
            \clef "treble_8"
...
\book {
    \bookOutputName "21-rota--in_dedicatione_templi-"
    \bookOutputSuffix "--choir_1-3-tenor--al_clef"
    \include "../include/paper-1-part.ly"
    \score {
        \new Voice << 
            \clef "alto"
