...
%Esperad que esté templada.
    ...
    Din din din
    \ijLyrics
    din dr -- rin din din __ din din di -- rin
    \normalLyrics
        din.
...
altusII = \relative c' {
    ...
    r1 | \invisibleTime\time 2/2 r1 | \singleTime\time 3/2 g2 a f | e1 r2 |
        a1 g2 | a1 r2 | a g d | e1 r2 | f e1 | e r2 | R1.*3 | r2 r e |
    ...
    d1 c2 r4 g' | g8[ g] g4 g8[ g] g4 g g8[ g] f4 e | 
        r4 g8[ g] f4 e r e f g | a2 g1\ficta fs2\unficta | g2 r4 d8[ d] 
    % --- page ---
    g4 g8[ g] g2 | r4 g a2. g4 g2 ~ | g\ficta fs\unficta g4 d8[ d] g4 e8[ f] |
...
tenorII = \relative c' {
    ...
    b2 r4 e2 d4 g4. g8 | f4 e d2 c e4 e | e2 e r2 f4 f |
        \invisibleTime\time 2/2 f2 f | \singleTime\time 3/2 
        e1 g2 | f1 e2 | c d1 | e1. | R1.*3 | \fourTwoCommonTime r2

    c2 c1 | c2 c b c | d1 c | R\breve | r4 b c b c2 b4 g | \invisibleTime
        \time 2/2 a2 b | \singleTime\time 3/2 R1.*4 | e2 e a, | b1 r2 |
        d b1 | a r2 | R1.*3 | r2 r 

    b2 | a2. b4 a2 | b1 g2 | a2. b4 a2 | \fourTwoCommonTime b1 c2. c4 |
    ...
    f1 | \singleTime\time 3/2 e1 r2 | R1. R | r2 r c | c2. d4 e2 | f d1 |
    ...
    d4 e r d c c8[ c] b[ b c c] | \invisibleTime\time 2/2 
        b8[ b] c4 r4 e | \time 6/2 f2 d1 c r2 | R\breve.*5 | r1. r2 r c |
        e1 f2 g1 a2 | f1 g2 a1 g2 |
    ...
    c2 | b1 b2 | c a1 | g g2 | R1. | c1 d2 | e a, b | c1 b2 | c d1 |
        \fourTwoCutTime c1 c | R\breve | r1 c2 d | e2. e4 e2 f | e c r1 |
    ...
    e2 f e c | f2. e4 d( c d2) | c\breve | r1 g4. g8 g4 g | a g a b c1 | 
        r1 r4 g a b | c2 r r1 | \singleTime\time 3/2 R1.*3 | r2 r e |
...
%    Can -- te -- mos con a -- le -- grí -- a
    To -- dos hoy __ por su ser -- vi -- cio.
    ¡E -- a, e -- a, sus, % em -- pe -- ce -- mos!
    Em -- pie -- ça tú, Gil Pi -- çar -- ra,
    A ta -- ñer con tu gui -- tar -- ra
    Y __ no -- so -- tros te~a -- yu -- da -- re -- mos.
