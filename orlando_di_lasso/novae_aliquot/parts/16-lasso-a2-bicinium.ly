...
cantusXVI = \relative c'' {
    ...
    c2 a2. bf4 c2 | g4 e f2 e1 | r2 d f e | g2. f8[ e] d4 e f2 |
        e4 f g a bf c d bf | c2 bf2. a8[ g] f4 g |

    e4 f g2 f4 g a bf | c2. bf4 a d, g2 ~ | 
        g4 \ficta fs8[ e] fs!2 \unficta g1 | r2 bf a c | f, bf2. a4 c2 |
        f4 d2 e4 f1 | r2 e

    f2 d | c4 f e2 f1 | r2 a g8[ f e d] c[ d e f] | g2 e r4 g c a | 
        bf2 a g4 d4. e8[ f d] |

    e8[ f g a] bf[ g a bf] c2 r4 f, ~ | f8[ g] a4 g bf a f r4 g |
        d'2 c bf8[ g] bf4 a8[ f] a4 | g2 f r4 g a f |

    % --- page ---
    bf2 g4 a d g'4. f8 e4 | d4. c8 d[ e f g] a[ f] bf2 a4 | 
        bf2 r4 d d4. c8 bf4 a | g f bf a d,8[ e f g] a[ bf] c4 |

    g8[ a] bf4 a8[ bf] c4 bf8[ c] d4 c8[ d] e4 | 
        d d,8[ e] f4 e8[ f] g4 d8[ e] f4 e8[ f] | g4 f8[ g] a4 g8[ a]

    bf4 a d4. c8 | \invisibleTime \time 6/2 
        bf4 a g f bf4. a8 g4 bf a4 g2 f4 | \invisibleTime \time 4/2
        g\longa*1/2
    \bar "|."
}
