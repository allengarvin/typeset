...
\header {
    ...
    subtitle = ""
    instrument = "Deus misereatur nostri:  (tenor II)"
    ...
    partname = "Tenor II (choir 2, part 3 of 8)"
    instrument = "Deus misereatur nostri:  (tenor II)"
...
\book {
    ...
    \bookOutputSuffix "ch2-3-tenor_2--tr8_clef"
    \include "../include/paper-1-part.ly"
    \score {
        \new Voice << 
            \clef "treble_8"
...
\book {
    \bookOutputName "29-lasso--deus_misereatur_nostri-"
    \bookOutputSuffix "ch2-3-tenor_2--al_clef"
    \include "../include/paper-1-part.ly"
    \score {
        \new Voice << 
            \clef "alto"
