...
\header {
    ...
    subtitle = "Credo"
    instrument = "Missa Puisque j'ai perdu: Credo (score)"
    headerspace = \markup { \vspace #2 }
    shorttitle = "missa_puisque_jai_perdu__credo"
    shortcomp = "lasso"
    needtranslation = #'t
    ...
    cksum = "87a3b44ae96f10d32781bc336cc4842152073e9d"
    tagline = #'f
}
