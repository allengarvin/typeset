chantXLIa = \relative c {
    \clef "vaticana-do3"
    \[ f \] \[ g( \pes a) \] \[ a \] \[ a \] \divisioMaior
    \[ a \] \[ a \] \[ g \] \[ a \] \[ c \] \[ g \] \[ g \] \[ \augmentum e \]
    \finalis
}
    
chantLyricsXLIa = \lyricmode {
    Ma -- gní _ -- fi --  cat á --  ni -- ma mé -- a Dó -- mi -- num.
}

chantXLIb = \relative c {
    \clef "vaticana-do3"
    \[ e \] \[ g( \pes a) \] \[ a \] \[ a \] \[ a \] 
    \[ a \] \[ a \] \[ a \] \[ a \] \[ a \] 
    \[ a \] \[ g \] \[ a \] \[ b \] \[ \augmentum a \] \divisioMaior 
...
% HACK, not sure why it's breaking
chantXLIbb = \relative c' {
    \clef "vaticana-do3"
    \[ a \] \[ a \] 
    \[ a \] \[ g \] \[ a \] \[ c \] \[ g \] \[ \augmentum e \] 
    \finalis
}

chantLyricsXLIb = \lyricmode {
    Qui -- a _ re -- spéx -- it hu -- mi -- li -- tá -- tem an -- cíl -- læ 
        sú -- æ; _
    ec -- ce é -- nim ex hóc be -- á -- tam me dí -- cent 
}

chantLyricsXLIbb = \lyricmode {
    ó -- mnes ge -- ne -- ra -- ti -- ó -- nes.
}
    
chantXLIc = \relative c {
    \clef "vaticana-do3"
    ...
    \[a\]\[a\]\[a\]\[a\]
    \[g\]
    \[a\]\[b\]\[a\]\[a\] \divisioMaior

    \[a\]\[g\]\[a\]\[c\]\[g\]\[\augmentum e\]
    \finalis
}

chantLyricsXLIc = \lyricmode {
    Et mi -- _ se -- ri -- cór -- di -- a é -- jus a pro -- gé -- ni -- e 
        in pro -- gé -- ni -- es 

    ti -- mén -- ti -- bus é -- um.
}

chantXLId = \relative c {
    \clef "vaticana-do3"
...
chantLyricsXLId = \lyricmode {
    De -- pó -- _ su -- it po -- tén -- tes de sé -- de, 
    et ex -- al -- tá -- vit hú -- mi -- les.
}

chantXLIe = \relative c {
    \clef "vaticana-do3"
...
chantLyricsXLIe = \lyricmode {
    Su -- scé -- _ pit I -- sra -- el, pú -- e -- rum sú -- um, 
    re -- cor -- dá -- tus mi -- se -- ri -- cór -- di -- æ sú -- æ.
}

chantXLIf = \relative c {
    \clef "vaticana-do3"
    \[ e \] \[ g( \pes a) \] \[ a \] 
    \[a\]\[a\]
    \[g\]
    ...
    \[a\]
    \[a\]\[g\]\[a\]\[c\]
    \[g\]\[\augmentum e\] \finalis
}
    
chantLyricsXLIf = \lyricmode {
    Glo -- rí -- _ a Pá -- tri, et Fí -- li -- o, 
        et Spi -- rí -- tu -- i Sán -- cto.
}

cantusXLIaincipit = \relative c'' {
    \time 2/2
    \clef "petrucci-c1"
    \key c \major
...
cantusXLIa = \relative c'' {
    ...
    c4 c c b | a2 b d1 | g, r2 a | d g, a d | c b a1 | gs\longa*1/2 
    \bar "|."
}

cantusLyricsXLIa = \lyricmode {
...
cantusXLIc = \relative c'' {
    \fourTwoCutTime
    \key c \major
    % --- page ---
    c1 b2 cs | d d e1 | d cs2 d | b a gs1 | a gs2 a | a b c g |

    a2. a4 a2 c ~ | c4( b a2. gs8[ fs] gs2) | a1 a | f2 e g2.( fs8[ e] |
        fs2) g a bf | 
...
bassusXLIc = \relative c {
    \fourTwoCutTime
    \clef bass
    \key c \major

    a1 e'2 a | d, g c,1 | R\breve*2 | a1 e'2 a | d, g c, c | f2. f4 f1 |
...
quintaVoxXLIaincipit = \relative c'' {
    \time 2/2
    \clef "petrucci-c1"
    \key c \major
...
quintaVoxXLIbincipit = \relative c' {
    \time 2/2
    \clef "petrucci-c1"
    \key c \major
...
quintaVoxXLIcincipit = \relative c'' {
    \time 2/2
    \clef "petrucci-c1"
    \key c \major
...
quintaVoxXLIdincipit = \relative c'' {
    \time 2/2
    \clef "petrucci-c1"
    \key c \major
...
quintaVoxXLIeincipit = \relative c'' {
    \time 2/2
    \clef "petrucci-c1"
    \key c \major
...
quintaVoxXLIfincipit = \relative c'' {
    \time 2/2
    \clef "petrucci-c1"
    \key c \major
...
quintaVoxXLIaincipitVoice = <<
    \new MensuralVoice <<
        { s1 \noBreak }
        \quintaVoxXLIaincipit
    >>
>>


cantusXLIbincipitVoice = <<
    \new MensuralVoice <<
        { s1 \noBreak }
        \cantusXLIbincipit
    >>
...
quintaVoxXLIbincipitVoice = <<
    \new MensuralVoice <<
        { s1 \noBreak }
        \quintaVoxXLIbincipit
    >>
>>

quintaVoxXLIcincipitVoice = <<
    \new MensuralVoice <<
        { s1 \noBreak }
        \quintaVoxXLIbincipit
    >>
