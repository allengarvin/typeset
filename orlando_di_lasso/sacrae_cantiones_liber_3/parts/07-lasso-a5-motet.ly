...
% innovantur naturæ. Deus homo factus est.
...
cantusVII = \relative c'' {
    ...
    f2 g | a1 r2 a | a d, d' bf ~ | bf4( a g1) \ficta fs2\unficta | g\breve |
        R | r1 r2 g ~ | g g a2.( g4 | f e d1) g2 | c,4( d e f g a b c |
        d2. c4 bf a bf2) |
    ...
    R\breve R | r1 r2 c ~ | c bf bf bf | a1 g2 a | d,1 r1 | a' g2 g |
...
cantusLyricsVII = \lyricmode {
    ...
    in -- no -- van -- tur na -- tu -- ræ.
        ...
        De -- us __ ho -- mo fa -- ctus est,
            fa -- ctus est.
    Id quod fu -- it per -- man -- sit,
    id quod fu -- it per -- man -- sit,
    id quod fu -- it per -- man -- sit __
...
altusLyricsVII = \lyricmode {
    ...
    id __ quod fu -- it per -- man -- sit,
        ...
        et quod non e -- rat as -- sum -- psit,
        et quod non e -- rat __ as -- sum -- psit,
    non com -- mix -- ti -- o -- nem pas -- sus, __
    non com -- mix -- ti -- o -- nem pas -- sus,
    non com -- mix -- ti -- o -- nem pas -- sus
...
tenorVII = \relative c' {
    ...
    bf2 a | d\breve ~ | d1 d1 | b\breve | R\breve*2 | r2 c1 c2 |
...
tenorLyricsVII = \lyricmode {
    ...
    id quod fu -- it per -- man -- sit,
        et quod non e -- rat as -- sum -- psit,
        et __ quod non e -- rat as -- sum -- psit,
        et quod non e -- rat as -- sum -- psit,
        et quod non e -- rat,
        et __ quod non e -- rat as -- sum -- psit,
    non __ com -- mix -- ti -- o -- nem pas -- sus,
    non com -- mix -- ti -- o -- nem,
    non __ com -- mix -- ti -- o -- nem pas -- sus
            ne -- que di -- vi -- si -- o -- nem,
            ne -- que di -- vi -- si -- o -- nem,
            ne -- que di -- vi -- si -- o -- nem,
...
quintusVII = \relative c' {
    ...
    r1 | e'1. d2 | d d c a | e'1 e | r2 b c a | b b c1 ~ | c2 a r2 c |
        a4( b c d e2) c | f,4( g a b c2) f | e2.( d4 c2) g | r2 g
    % --- page ---
...
quintusLyricsVII = \lyricmode {
    Mi -- ra -- bi -- le __ my -- ste -- ri -- um,
    mi -- ra -- bi -- le my -- ste -- ri -- um, __
        my -- ste -- ri -- um de -- cla -- ra -- tur ho -- di -- e,
            de -- cla -- ra -- tur ho -- di -- e:
    in -- no -- van -- tur na -- tu -- ræ,
    in -- no -- van -- tur na -- tu -- ræ.
        De -- us ho -- mo fa -- ctus est,
    ...
    id quod fu -- it per -- man -- sit,
        ...
        et quod non e -- rat as -- sum -- psit,
        et quod non e -- rat as -- sum -- psit,
            non e -- rat __ as -- sum -- psit,
    non com -- mix -- ti -- o -- nem pas -- sus,
    non com -- mix -- ti -- o -- nem pas -- sus,
        com -- mix -- ti -- o -- nem pas -- sus
            ne -- que __ di -- vi -- si -- o -- nem,
            ne -- que __ di -- vi -- si -- o -- nem,
            ne -- que __ di -- vi -- si -- o -- nem,
            ne -- que di -- vi -- si -- o -- nem,
