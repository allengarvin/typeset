...
cantusXII = \relative c'' {
    ...
    b\breve | gs | a1 a | r1 d ~ | d b2 d ~ | d c2.( b8[ a] b2 ~ |
        b) c2.( b4 a2 ~ | a) \ficta gs\unficta a1 | r2 a fs1 | g2 g g2. g4 |
        a1 r1 | d g,2 c ~ | c b
    ...
    b4( a b c | d1) d | r2 d, a'4( g a b | c b c d e1) | e2 a, g c ~ |
        c c c1 | d1. a2 | a\breve | gs\longa*1/2
    \bar "|."
}
...
altusXII = \relative c' {
    ...
    d2) c d1 | b e2 f ~ | f f e2.( f4 | g2) f2.( e4 e2 ~ | e4 f g2) g1 |
        e2 d e1 | r2 e e1 | d2 e1 e2 | e d e f ~ | f e d d | g, c e1 |

    d2 d1 d2 | d1. cs2 | d f1 e2 | f d e1 | d g ~ | g g ~ | g2 g f1 |
        e2 e e1 | e r2 g | a1 g ~ | g2 g f1 | e2 e e1 | e\longa*1/2
    \bar "|."
}
...
tenorXII = \relative c' {
    ...
    r1 b ~ | b b | a1. a2 | d1. d2 | a1 r1 | g\breve | e1 f | e e'2. e4 |
...
quintusXII = \relative c {
    ...
    R\breve | r1 e ~ | e fs | g d ~ | d d' | b2 e2.( d8[ c] d2) |
