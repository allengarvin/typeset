...
% Invocation: /usr/local/bin/generate-single.py -t "Jerusalem plantabis vineam" -f "Responsory for Advent II" -l latin -v -m 120 04-lasso-a5-0-score.ly cantus:t altus:t8a quintus:t8a tenor:8a bassus:b --subtitle "Prima pars"
...
\header {
    ...
    subtitle = "Prima pars"
    subsubtitle = ""
    instrument = "Jerusalem plantabis vineam: Prima pars (quintus)"
