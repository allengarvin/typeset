...
\book {
    \bookOutputName "16-byrd--o_you_that_hear_this_voice-cpdl_ediiton"
    ...
    \score {
         <<
            \new ChoirStaff = choirStaff \with {
             ...
             \addlyrics { \superiusLyricsXVIa }
             \addlyrics { \superiusLyricsXVIb }
             \addlyrics { \superiusLyricsXVIc }
             \addlyrics { \superiusLyricsXVId }
                \new Voice <<
    ...
    \markup { 
        \fill-line {
            \column {
                \line { \italic { The nine verses do not evenly line up in the pattern here. } }
                \line { \italic { It is recommend there the first section of the second refrain be repeated, to get all the verses in. } }
                \line { \italic { (Fretwork does this on their album of Byrd Consort Songs, which is where I got the idea) } }
                \line { \vspace #1 }
            }
        }
    }
