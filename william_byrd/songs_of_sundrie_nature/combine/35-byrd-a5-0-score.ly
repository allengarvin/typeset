...
\header {
    ...
    title = "From Virgin's womb this day / Rejoice, rejoice"
...
\book {
    \bookOutputName "35-byrd--from_virgins_womb_this_day--combined"
    \bookOutputSuffix "--0-score"
    \score {
        \header { piece = "The first part (consort song)" }
         <<
    ...
    \score {
        \header { piece = "The second part (chorus)" }
         <<
            \new ChoirStaff = choirStaff \with {
                \override StaffGrouper.staff-staff-spacing.padding = #4.5
            } <<
