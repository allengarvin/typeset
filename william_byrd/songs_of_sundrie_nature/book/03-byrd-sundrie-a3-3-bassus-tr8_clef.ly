...
\book {
    ...
    \score {
        \new Voice << \clef "treble_8" \global \bassusI  >>
    ...
    \markup { \fill-line { \column { \line { \vspace #2 } } } }
    \score {
        \new Voice << \clef "treble_8" \global \bassusII  >>
    ...
    \markup { \fill-line { \column { \line { \vspace #2 } } } }
    \score {
        \new Voice << \clef "treble_8" \global \bassusIII  >>
    ...
    \markup { \fill-line { \column { \line { \vspace #2 } } } }
    \score {
        \new Voice << \clef "treble_8" \global \bassusIV  >>
    ...
    \markup { \fill-line { \column { \line { \vspace #2 } } } }
    \score {
        \new Voice << \clef "treble_8" \global \bassusV  >>
    ...
    \markup { \fill-line { \column { \line { \vspace #2 } } } }
    \score {
        \new Voice << \clef "treble_8" \global \bassusVI  >>
    ...
    \markup { \fill-line { \column { \line { \vspace #2 } } } }
    \score {
        \new Voice << \clef "treble_8" \global \bassusVII  >>
...
\layout {
    ...
    \markup { \fill-line { \column { \line { \vspace #2 } } } }
    \score {
        \new Voice << \clef "treble_8" \global \bassusVIII  >>
    ...
    \markup { \fill-line { \column { \line { \vspace #2 } } } }
    \score {
        \new Voice << \clef "treble_8" \global \bassusIX  >>
    ...
    \markup { \fill-line { \column { \line { \vspace #2 } } } }
    \score {
        \new Voice << \clef "treble_8" \global \bassusX  >>
    ...
    \markup { \fill-line { \column { \line { \vspace #2 } } } }
    \score {
        \new Voice << \clef "treble_8" \global \bassusXI  >>
    ...
    \markup { \fill-line { \column { \line { \vspace #2 } } } }
    \score {
        \new Voice << \clef "treble_8" \global \bassusXII  >>
    ...
    \markup { \fill-line { \column { \line { \vspace #2 } } } }
    \score {
        \new Voice << \clef "treble_8" \global \bassusXIII  >>
    ...
    \markup { \fill-line { \column { \line { \vspace #2 } } } }
    \score {
        \new Voice << \clef "treble_8" \global \bassusXIV  >>
