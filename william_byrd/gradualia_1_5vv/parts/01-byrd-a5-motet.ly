...
mediusI = \relative c' {
    ...
    c2 e, ~ | e4( f g e) a1 | r2 f1( g4 a | bf1) a | r1 g ~ | g g |
        g2 a2. bf4( c bf | a g) f2 r2 d | f d e2.( d8[ e] |
        f4 e c2) d1 | r2 a' 
...
tenorI = \relative c' {
    ...
    \bar "||"
    % wrong number of rests by 6 minims
    R\breve*3 R\breve*5 R\breve*5 R\breve*5 R\breve | r2
    % --- page ---
    a2. a4 g2 | f4.( g8 a4 f) g1 | g2 a1 bf2 | a1 d2 c ~ | c c2 f, bf | a1 g |
        r2 g1 g2 | g g r2

    g2 | f a4( g f) g a2 | a1 g2 bf | a f a2.( g4 | f e d2) a'1 ~ | a r1 |
        r1 c2 c | d2. f4 e1 |

    d2. d4 a1 | d,2 f( g a2 ~ | a4 g4 f g) a1 | r1 a2. d,4 | f1 c |
        f1.( d2 | f2. g4 a1) | 
        a\longa*1/2
...
bassusI = \relative c {
    ...
    R\breve*3 R\breve*5 R\breve*5 R\breve*5 R\breve | r2
    % --- page ---
    f2. f4 e2 | f1 c | g'2 fs1 g2 | d1 d2 a'2 ~ | a4 a4 f1 g2 | d1 g |
        r2 c,1 b2 | c4( d e f) 

    g1 | d2 cs d2. d4 | a2 a' bf1 | f2 a2.( g4 f e | d1) a | r2 a'1 bf2 | 
        c2. c4 f,2 f ~ | f g2 

    a2. a4 | d,1 f1 ~ | f c1 | d a | c f | r2 c'1 g2 | a d, f2.( g4 | a\breve)|
        d,\longa*1/2
