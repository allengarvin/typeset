...
% Invocation: /usr/local/bin/generate-single.py -t "I' vidi in terra angelici costumi" -l italian -p sonnet -v -m 84 -s 15 -u "Prima parte" 21-gabrieli-a5-0-score.ly --subsubtitle "transposed down" canto:t alto:t8a quinto:8a tenore:8a basso:b
...
\header {
    ...
    instrument = "I' vidi in terra angelici costumi: Prima parte (tenore)"
