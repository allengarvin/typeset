...
\header {
    ...
    subtitle = ""
    subsubtitle = ""
    instrument = "Tirsi, che fai così dolente:  (ottava)"
    headerspace = \markup { \vspace #2 }
    shorttitle = "tirsi_che_fai_cosi_dolente"
    shortcomp = "gabrieli"

    % Things that change per part:
    partname = "Ottava (Choir II, part 3 of 4)"
    instrument = "Tirsi, che fai così dolente:  (ottava)"
...
\book {
    ...
    \bookOutputSuffix "--ch_2-3-ottava--tr8_clef"
    \include "../include/paper-1-part.ly"
    \score {
        \new Voice << 
            \clef "treble_8"
...
\book {
    \bookOutputName "17-gabrieli--tirsi_che_fai_cosi_dolente-"
    \bookOutputSuffix "--ch_2-3-ottava--al_clef"
    \include "../include/paper-1-part.ly"
    \score {
        \new Voice << 
            \clef "alto"
