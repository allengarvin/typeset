...
\header {
    ...
    subsubtitle = ""
    instrument = "O Dea che tra le selve: Risonanza di eco (alto II)"
    headerspace = \markup { \vspace #2 }
    shorttitle = "o_dea_che_tra_le_selve"
    shortcomp = "gabrieli"

    % Things that change per part:
    partname = "Alto I (Choir II, part 2 of 4)"
    instrument = "O Dea che tra le selve: Risonanza di eco (alto II)"
...
\book {
    ...
    \bookOutputSuffix "--6-alto_2--tr_clef"
    \include "../include/paper-1-part.ly"
    \score {
        \new Voice << 
            \clef "treble"
...
\book {
    \bookOutputName "19-gabrieli--o_dea_che_tra_le_selve-risonanza_di_eco"
    \bookOutputSuffix "--6-alto_2--al_clef"
    \include "../include/paper-1-part.ly"
    \score {
        \new Voice << 
            \clef "alto"
