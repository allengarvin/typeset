...
\header {
    ...
    subtitle = ""
    subsubtitle = ""
    instrument = "Tirsi, che fai così dolente:  (tenore)"
    headerspace = \markup { \vspace #2 }
    shorttitle = "tirsi_che_fai_cosi_dolente"
    shortcomp = "gabrieli"

    % Things that change per part:
    partname = "Tenore (Choir I, part 3 of 4)"
    instrument = "Tirsi, che fai così dolente:  (tenore)"
...
\book {
    ...
    \bookOutputSuffix "--ch_1-3-tenore--tr_clef"
    \include "../include/paper-1-part.ly"
    \score {
        \new Voice << 
            \clef "treble"
...
\book {
    \bookOutputName "17-gabrieli--tirsi_che_fai_cosi_dolente-"
    \bookOutputSuffix "--ch_1-3-tenore--al_clef"
    \include "../include/paper-1-part.ly"
    \score {
        \new Voice << 
            \clef "alto"
