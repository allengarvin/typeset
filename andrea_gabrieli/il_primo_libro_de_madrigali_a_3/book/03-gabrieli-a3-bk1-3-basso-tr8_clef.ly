...
\book {
    \score {
        \new Voice << \clef "treble_8" \global \bassoI  >>
    ...
    \score {
        \new Voice << \clef "treble_8" \global \bassoII  >>
    ...
    \pageBreak
    \score {
        \new Voice << \clef "treble_8" \global \bassoIII  >>
    ...
    \score {
        \new Voice << \clef "treble_8" \global \bassoIV  >>
    ...
    \pageBreak
    \score {
        \new Voice << \clef "treble_8" \global \bassoV  >>
    ...
    \score {
        \new Voice << \clef "treble_8" \global \bassoVI  >>
    ...
    \pageBreak
    \score {
        \new Voice << \clef "treble_8" \global \bassoVII  >>
    ...
    \score {
        \new Voice << \clef "treble_8" \global \bassoVIII  >>
    ...
    \pageBreak
    \score {
        \new Voice << \clef "treble_8" \global \bassoIX  >>
    ...
    \pageBreak
    \score {
        \new Voice << \clef "treble_8" \global \bassoX  >>
    ...
    \score {
        \new Voice << \clef "treble_8" \global \bassoXI  >>
    ...
    \pageBreak
    \score {
        \new Voice << \clef "treble_8" \global \bassoXII  >>
    ...
    \pageBreak
    \score {
        \new Voice << \clef "treble_8" \global \bassoXIII  >>
    ...
    \score {
        \new Voice << \clef "treble_8" \global \bassoXIV  >>
    ...
    \pageBreak
    \score {
        \new Voice << \clef "treble_8" \global \bassoXV  >>
...
%------------
    \score {
        \new Voice << \clef "treble_8" \global \bassoXVI  >>
    ...
    \pageBreak
    \score {
        \new Voice << \clef "treble_8" \global \bassoXVII  >>
...
%------------
    \score {
        \new Voice << \clef "treble_8" \global \bassoXVIII  >>
    ...
    \score {
        \new Voice << \clef "treble_8" \global \bassoXIX  >>
...
%------------
    \score {
        \new Voice << \clef "treble_8" \global \bassoXX  >>
    ...
    \score {
        \new Voice << \clef "treble_8" \global \bassoXXI  >>
...
%------------
    \score {
        \new Voice << \clef "treble_8" \global \bassoXXII  >>
