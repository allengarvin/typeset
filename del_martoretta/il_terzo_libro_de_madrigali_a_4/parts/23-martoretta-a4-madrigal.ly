...
cantoXXIII = \relative c'' {
    ...
    a2 g f e | d g f4 g e2 | d1 r2 d' | c bf a g | f e d2. e4 | f2 g r4 d'2 d4 |
        c4.( bf8 a[ g f e]) d4 g2\melisma\ficta fs4\unficta\melismaEnd |

    g2 r4 g bf2 c | d bf a2. a4 | bf c d1 cs2 | r2 a bf bf | bf\breve |
        a2 r4 a c2. bf4 | a g bf a g f e2 | d\breve | R\breve | r2 d2. d4 d2 |
    ...
    c2 ~ | c b r1 | d2 c4 a bf c d2 | c bf a g2 ~ | 
...
cantoLyricsXXIII = \lyricmode {
    Deh, do -- ve sen -- za me, dol -- ce mia vi -- ta, __
...
altoXXIII = \relative c'' {
    ...
    e4 f g( f f e8[ d] | e1) d2 r4 f ~ | f e2 d c4 g'2 | 
        f4. e8 d4 c2 bf4 c2 ~ | 
        c4 bf4 g4.( a8[ bf c]) d2 \ficta cs4 \unficta | d2 f e d4 bf | 
        c2 r4 d2
    ...
    f2 r4 f a2. g4 | f e d f e d2 c4 | d fs fs fs g2 d | r4 d d c d2. e4 |
    ...
    g1 r4 a' f e | f g e f g2 f | e d r d | c a b4 b c c | d2 ef ef1 |
        d\longa*1/2
    \bar "|."
}

altoLyricsXXIII = \lyricmode {
    Deh, __ do -- ve sen -- za me, 
    \ijLyrics
    Deh, do -- ve sen -- za me, 
    \normalLyrics
        dol -- ce mia vi -- ta,
...
tenoreXXIII = \relative c' {
    ...
    c2 f,1 bf2 | a r4 d g, a bf bf | a1 d,2 d' | c bf a g | a4 a bf c a f g2 ~ |
        g bf4. c8 d4 g, a2 | d, r4 a'2 g f4 ~ | f e4.( d8 
    ...
    a2 c c f ~ | f4( e d c) bf2 bf | c1 bf2.( a4) | g2 f e d | c1 d2 r4 d' |
        c a bf c a bf c d | g,2 a1 bf4 g ~ | g f bf2 a1 | 

    g2 e e4 d c2 | d r4 d' c a bf c | a bf c d g,2 a ~ | a bf f g |
        a1 g2 g | bf bf c1 | b\longa*1/2
    \bar "|."
}
...
tenoreLyricsXXIII = \lyricmode {
    ...
    Deh, do -- ve sen -- za me, __ dol -- ce mia vi -- ta,
    \normalLyrics
    Ri -- ma -- sa sei sì gio -- va -- ne~e sì bel -- la bel -- la?
...
bassoXXIII = \relative c' {
    ...
    r1 | r1 r2 bf' | a g f g | d4 f g c, d2( c) | g1 r | r2 d' c bf |
        a g d'4 d ef c | d d r2 r g | f2 e d bf | c f 

    g4 c, d2 | g, g' g a | bf g f a | g4 f bf2 a1 | r2 f g ef | bf'2.( a4 g1) | 
        f r | R\breve | r2 d g2. f4 | e d f e d c bf2 |

    a2 d2. d4 d2 | d c f2. g4 | a2 bf \[ g1( | f) \] bf,2 ef ~ | 
        ef bf c g | a1 g2 g' | a4 f g a d, g a f | ef2 d r g, | d' bf

    c2 d | g, c c4 bf a2 | g g' a4 f g a | d, g a f ef2 d | 
        r2 g, d' bf | c d g, c | g' ef c1 | g\longa*1/2
    \bar "|."
}
