...
% Invocation: /usr/local/bin/generate-single.py -t "Ma non sì tosto dal materno stelo" -p "ottava rima" -m 112 -s 17 -l italian -v 33-wert-a4-0-score.ly --subsubtitle "transposed down" canto:t alto:8a tenore:8a basso:b
...
\header {
    ...
    instrument = "Ma non sì tosto dal materno stelo:  (basso)"
