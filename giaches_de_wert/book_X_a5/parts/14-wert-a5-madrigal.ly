...
cantoXIV = \relative c'' {
    ...
    a1. g2 | f( e4 d e1) | d r2 a' | b4 b c1 bf2 ~ | bf a2. g4 g2 ~ |
        g\melisma\ficta fs\unficta\melismaEnd g r4 d | d2 e f1 ~ | f2 f g a |
    ...
    a2.( g4 | f2) g bf4 bf bf2 ~ | bf bf r1 | R\breve | r1 r2 ef |
        ef4 ef ef ef d2.\melisma c4 | bf2 d d \ficta cs\unficta\melismaEnd |
    ...
    c4 d bf2 ~ | bf4 a \[ a1\melisma g2 ~ | 
        ...
        bf4 a \[ a1\melisma g \] \ficta fs4\unficta\melismaEnd 
        g\longa*1/2
    \bar "|."
}
...
altoXIV = \relative c' {
    ...
    d4) d f2.( d4 g2) | f\breve | f1 f2 d2.( c8[ bf] a2) b\longa*1/2
    \bar "|."
}
...
tenoreXIV = \relative c' {
    ...
    r1 r2 d | g, c bf bf ~ | bf bf f1 ~ | f bf2 g | c f, r4 f f f |
        bf2 f f2. f4 | f2 d g1 | g r1 | R\breve*2 | r1 a | a2 bf 

    a2 a | d,1 d | R\breve*2 | r2 d d1 ~ | d2 c f1 ~ | f2 d d f | 
...
bassoXIV = \relative c' {
    ...
    d2) e | f1 f | f2 f d\breve g,\longa*1/2
    \bar "|."
}
...
quintoXIV = \relative c' {
    ...
    g4 g g g f2.( e4 | d2) c g' g, | bf4( c d e f2) d | R\breve | 
