...
\book {
    ...
    \score {
        \new Voice = Canto << \clef alto \global \altoI  >>
    ...
    \markup { \fill-line { \column { \line { \vspace #2 } } } }
    \score {
        \new Voice = Canto << \clef alto \global \altoIII  >>
    ...
    \score {
        \new Voice = Canto << \clef alto \global \altoXI >>
    ...
    \score {
        \new Voice = Canto << \clef alto \global \altoXII >>
    ...
    \markup { \fill-line { \column { \line { \vspace #2 } } } }
    \score {
        \new Voice = Canto << \clef alto \global \altoXIII >>
    ...
    \markup { \fill-line { \column { \line { \vspace #2 } } } }
    \score {
        \new Voice = Canto << \clef alto \global \altoXIV >>
    ...
    \markup { \fill-line { \column { \line { \vspace #2 } } } }
    \score {
        \new Voice = Canto << \clef alto \global \altoXVI >>
    ...
    \markup { \fill-line { \column { \line { \vspace #2 } } } }
    \score {
        \new Voice = Canto << \clef alto \global \altoXVII >>
    ...
    \markup { \fill-line { \column { \line { \vspace #2 } } } }
    \score {
        \new Voice = Canto << \clef alto \global \altoXVIII >>
