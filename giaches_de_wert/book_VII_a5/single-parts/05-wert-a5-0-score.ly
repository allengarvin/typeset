...
\header {
    ...
    instrument = "Ben, se'l petto talor mi ripercote (score)"
    needtranslation = #'t
    language = "italian"
    ...
    cksum = "32ed636b2b1bab4566a8aef0699a09e365db0cb7"
    tagline = #'f
}
...
\book {
    \bookOutputName "05-wert---ben_sel_petto_talor_mi_ripercote-"
