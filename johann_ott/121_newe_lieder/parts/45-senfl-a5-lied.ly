...
discantusXLV = \relative c' {
    ...
    e2 f2. g4 a2 ~ | a4 g f e f2 a ~ | a4) g g2 r a | g( c1) bf2 |
        c g2.( f4 e2) | d\melfi e d c ~ | c4 d e2 c2. d4 | 
        e c c'1\melfiEnd\ficta b2\unficta |
    ...
    f2) c f e ~ | e f2 g2.( d4 | f1) e ~ | e e1 | f2.( g4) a2. bf4 |
        c2 c, d1 ~ | d2( e2 d) d | e1 r1 | e f2( e) | d a'2.( bf4 c2 | d) d, 
...
discantusLyricsXLV = \lyricmode {
   ...
   \ijLyrics
    des Wun -- ders noch, 
    des __ Wun -- ders noch 
    Was wird __ es doch des __ Wun -- ders noch  __
    so gar __ ein sel -- tsams Le -- ben,
    so gar __ ein sel -- tsams Le -- ben,
        ein sel -- tsams Le -- ben. __

    Gut Wort arg Tück,
    Gut Wort arg Tück, __
    viel Grüß __ bös Blick, __
    viel Grüß bös Blick,

    Gut Wort __ arg Tück,
    Gut Wort arg Tück,
    viel Grüß bös Blick, __
        bös Blick,

    ist jetz der Sitt' auff Er -- den
        der Sitt' __ auff Er -- den. __
    Es günd __ Kei -- ner mer
    dem an -- dern eer,
    Was will __ noch da -- raus wer -- den?
        noch da -- raus,
        noch da -- raus wer -- den,
        noch da -- raus __ wer -- den? __
}
...
contratenorXLV = \relative c {
    ...
    % --- page ---
    f2 e d) e | f1 g2 a ~ | a4( g) f1 e2 | a1.( g2) | f a2.( bf4 c2) | 
        d g,1( c2 ~ | c4 bf) a1 g2 | a2.( bf4 c1) | f,2( bf) a1 | f2 c'2.( bf4
    ...
    % --- page ---
    f1 r1 | c'1 c2.( bf4) | a2.( g4) f1 | a r2 a | bf4( a g f g2) g |
        g1 r2 g | a bf c1 | a1. f2 | f1 r2 g | e f2 e2.( d8[ c]) | g'1 
...
contratenorLyricsXLV = \lyricmode {
   ...
   \ijLyrics
    ...
    was will noch draus __ wer -- den,
    was will noch draus wer -- den,
        draus __ wer -- den?
}
...
tenorXLV = \relative c {
    ...
    d1.( c2) | bf( a) g f | a( bf g1) | f\breve~f | 
        ...
        r1 a | a a |
        g\breve | r1 bf | bf bf | a\breve | r1 c | d e | f f2 g ~ | 
        g( f4 e d1) |
...
bassusXLV = \relative c {
    ...
    % --- page ---
    a2.( bf4 c1) | g d'2.( e4 | f g a2) g g, | a2.( g4 a bf c2) | f,\breve |
        f' | c\breve~c\longa*1/2
...
bassusLyricsXLV = \lyricmode {
   ...
   \ijLyrics
    des Wun -- ders noch,
    des Wun -- ders noch,
    Was wird es doch des Wun -- ders noch __
    so gar __ ein sel -- tsams Le -- ben,
    so gar __ ein sel -- tsams Le -- ben,
        gar __ ein __ sel -- tsams Le -- ben. __
    ...
    ist jetz der Sitt' auff Er -- den
    Es günd Kei -- ner mer dem an -- dern eer,
        an -- dern eer,
    Was will __ noch da -- raus __ wer -- den,
            wer -- den,
        draud wer -- den,
            wer -- den? __
}
...
vagansXLV = \relative c' {
    ...
    % --- page ---
    c1 r2 e | f\breve | d1 g2 bf | a1\melfi g | bf a2. g4 | 
        a bf c1 b2\melfiEnd | c1 r2 g | a2.( g4 a bf) c2 ~ | c4( bf a g) a1( |
        g) r1 | g\longa*1/2
    \bar "|."
}
...
vagansLyricsXLV = \lyricmode {
   ...
   \ijLyrics
    ...
    ist jetz der Sitt' auff Er -- den. __
    Es günd Kein'r mer __
    dem an -- dern eer,
    Was will noch da -- raus wer -- den?
        noch da -- raus __ wer -- den?
}
