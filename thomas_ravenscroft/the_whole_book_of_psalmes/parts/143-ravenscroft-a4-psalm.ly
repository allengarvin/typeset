...
cantusCXLIIIincipit = \relative c'' {
    \time 4/4
    \clef "petrucci-g"
    \key f \major
...
mediusCXLIIIincipit = \relative c'' {
    \time 4/4
    \clef "petrucci-c2"
    \key f \major
...
bassusCXLIIIincipit = \relative c' {
    \time 4/4
    \clef "petrucci-f3"
    \key f \major
