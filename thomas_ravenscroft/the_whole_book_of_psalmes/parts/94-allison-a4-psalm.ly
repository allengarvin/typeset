...
cantusLyricsXCIVb = \lyricmode {
}

mediusXCIVincipit = \relative c' {
    \time 6/4
    \clef "petrucci-c3"
    \key f \major
...
mediusLyricsXCIVb = \lyricmode {
}

tenorXCIVincipit = \relative c {
    \time 6/4
    \clef "petrucci-c4"
    \key f \major
...
tenorLyricsXCIVb = \lyricmode {
}

bassusXCIVincipit = \relative c {
    \time 6/4
    \clef "petrucci-f4"
    \key f \major
...
bassusLyricsXCIVb = \lyricmode {
}

cantusXCIVincipitVoice = <<
    \new MensuralVoice <<
        { s1 \noBreak }
        \cantusXCIVincipit
    >>
