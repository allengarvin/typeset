...
% Con gloria sua e vostro eterno onore,
% Di volgervi a quel raggio a quel splendore
% Che da bei sette colli manda Carlo
% A la gran Roma sua, e sì mirarlo
% Ch'io dice: occhi beati a tutte l'ore.
...
cantoLyricsI = \lyricmode {
    Oc -- chi si de per voi __ giun -- ger al co -- re
    Di -- vin o -- biet -- to per mai sem -- pre~a -- mar -- lo
    Temp' or' è ben,
    temp' or' è ben se de -- si -- a -- te far -- lo
    Con glo -- ria sua e vo -- str'e -- ter -- n'o -- no -- re
    Di vol -- ger -- vi~a quel rag -- gio~a quel splen -- do -- re
    Che da bei set -- te col -- li man -- da Car -- lo
    A la gran Ro -- ma sua, e sì mi -- rar -- lo
    Ch'io di -- ca: oc -- chi be -- a -- ti a tut -- te l'o -- re,
        e sì mi -- rar -- lo
    ch'io di -- ca: oc -- chi be -- a -- ti __ a tut -- te l'o -- re,
        a tut -- te l'o -- re,
        a tut -- te l'o -- re.
}
...
altoI = \relative c' {
    ...
    b4 c4.( b8[ a g] f2) \ficta bf \unficta | a1 f2 r | r4 a a g g c, e d |
        c2. a4 g2 a4 d | e f g a b c b a | gs( a2 gs4) a2 r | a2 a4 a 
...
altoLyricsI = \lyricmode {
    Oc -- chi si de per voi giun -- ger al co -- re,
        giun -- ger al co -- re
    Di -- vin o -- biet -- to per mai sem -- pre~a -- mar -- lo
    Temp' or' è ben se de -- si -- a -- te far -- lo,
    temp' or' è ben se de -- si -- a -- te far -- lo
...
tenoreI = \relative c' {
    ...
    f4 e2 d cs4 d2 | R\breve | r1 e2 e4 e | fs2 r r4 g fs g | 
        c,2 r4 g a b c a | \[ f'1( e) \] | d1 r4 c a g | a b c2. b4 b c |
        d2 d4 e 
    ...
    b4 b b b | d2 c4 a c2 b ~ | b4 b b2 a4.( b8 cs4. d8 | e2.) e4 d4. c8 b2 |
        a4 a' fs fs g2 a | r4 a g2. f4 e2 | d4 d d d f2 d | r4 e e e 
...
bassoI = \relative c {
    ...
    g4 e g2 | f4 d f2 c e | e e a1 ~ | a1 d,2 e | cs d e a,4 a' | 
...
quintoI = \relative c' {
    ...
    d1 cs2 r4 a | d2. e4 f2 e ~ | e4 e cs2 d1 | e a2. a4 | a2 a1 gs2 |
        a g4 f f2 f4 a | g a4.( g8[ f e] d2) g |

    f4( e8[ d] e2) d4 a a b | c2 r r1 | r1 r2 r4 a | c d e f g a gs a |
    ...
    cs4 d e2 | fs4 fs fs fs a2 a,4 a | c2 a r4 b b b | d2 c4 a c2 b ~ | 
        b4 b b2 a4.( b8 cs4. d8 | e2) a,1. | e'2 c d e | a,1 r2 r4 e' | 
        cs2 d 
...
quintoLyricsI = \lyricmode {
    ...
    A la gran Ro -- ma sua,
    a la gran Ro -- ma sua, e sì mi -- rar -- lo
    Ch'io di -- ca~oc -- chi be -- a -- ti a tut -- te l'o -- re, __
        a tut -- te l'o -- re,
        e sì mi -- rar -- lo,
    ch'io di -- ca,
        e sì mi -- rar -- lo,
