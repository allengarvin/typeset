...
\header {
    ...
    subtitle = "Choir quarto"

    % Things that change per part:
    composer = "Tiburto Massaino (c.1550-1609)"
    instrument = "Canzon trigesimaquinta (tenore)"
    partname = "Tenore (choir IV) (part 15 of 16)"
...
\book {
    ...
    \bookOutputSuffix "-c4-3-tenore--tr8_clef"
    \include "../include/paper-1-part.ly"
    \score {
        \new Voice << 
            \clef "treble_8"
...
\book {
    \bookOutputName "35-canzon-parts"
    \bookOutputSuffix "-c4-3-tenore--al_clef"
    \include "../include/paper-1-part.ly"
    \score {
        \new Voice << 
            \clef alto
