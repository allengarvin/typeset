...
\header {
    ...
    subtitle = ""
    instrument = "Giocond'e crudo fato:  (score)"
...
\book {
    ...
    \markup {
        \fill-line {
            \column {
                \line { Giocond'e crudo fato }
                \line { che'n si oscura prigion mi doni aita, }
                \line { grato dolor ch'or mi dai mort'or vita }
                \line { e fai vario'l mio stato, }
