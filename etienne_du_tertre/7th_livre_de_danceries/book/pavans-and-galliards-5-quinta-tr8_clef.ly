...
\book {
    \score {        
        \new Voice << \clef "treble_8" \global \tenorTwoV >>  
        \include "../include/layout-parts.ly"
        \header { piece = "Pavane III a cinq" }
    }
    \score {
        \new Voice << \clef "treble_8" \global \tenorTwoVI >>  
        \include "../include/layout-parts.ly"
        \header { piece = "Galliarde III a cinq" }
    }
    \score {
        \new Voice << \clef "treble_8" \global \bassusOneXI >>
        \include "../include/layout-parts.ly"
        \header { piece = "Pavane VI a cinq" }
    }
    \score {
        \new Voice << \clef "treble_8" \global \bassusOneXII >>
        \include "../include/layout-parts.ly"
