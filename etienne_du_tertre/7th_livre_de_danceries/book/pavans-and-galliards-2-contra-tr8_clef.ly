...
\book {
    \score {
        \new Voice << \clef "treble_8" \global \contraI >>
        \include "../include/layout-parts.ly"
        \header { piece = "Pavane I" }
    }
    \score {
        \new Voice << \clef "treble_8" \global \contraII >>
        \include "../include/layout-parts.ly"
        \header { piece = "Galliarde I" }
    }
    \score {
        \new Voice << \clef "treble_8" \global \contraIII >>
        \include "../include/layout-parts.ly"
        \header { piece = "Pavane II" }
    }
    \score {
        \new Voice << \clef "treble_8" \global  \contraIV >>  
        \include "../include/layout-parts.ly"
        \header { piece = "Galliarde II" }
    }
    \score {        
        \new Voice << \clef "treble_8" \global \contraV >>  
        \include "../include/layout-parts.ly"
        \header { piece = "Pavane III a cinq" }
    }
    \score {
        \new Voice << \clef "treble_8" \global \contraVI >>  
        \include "../include/layout-parts.ly"
        \header { piece = "Galliarde III a cinq" }
    }
    \score {
        \new Voice << \clef "treble_8" \global \contraVII >>  
        \include "../include/layout-parts.ly"
        \header { piece = "Pavane IV" }
    }
    \score {
        \new Voice << \clef "treble_8" \global \contraVIII >>  
        \include "../include/layout-parts.ly"
        \header { piece = "Galliarde IV" }
    }
    \score {
        \new Voice << \clef "treble_8" \global \contraIX >>  
        \include "../include/layout-parts.ly"
        \header { piece = "Pavane V" }
    }
    \score {
        \new Voice << \clef "treble_8" \global \contraX  >>  
        \include "../include/layout-parts.ly"
        \header { piece = "Galliarde V" }
    }
    \score {
        \new Voice << \clef "treble_8" \global \contraXI >>
        \include "../include/layout-parts.ly"
        \header { piece = "Pavane VI a cinq" }
    }
    \score {
        \new Voice << \clef "treble_8" \global \contraXII >>
        \include "../include/layout-parts.ly"
