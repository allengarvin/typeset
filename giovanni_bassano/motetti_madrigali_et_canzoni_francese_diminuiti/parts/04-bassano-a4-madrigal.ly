cantoBassanoIVincipit = \relative c'' {
    \time 2/2
    \clef "petrucci-c1"
    \key c \major
...
cantoBassanoLyricsIV = \lyricmode {
    ...
    et co -- sì mil -- le~e mil -- le __ vol -- te~il __ gior -- no,
        mil -- le~e mil -- le vol -- te~il gior -- no,
...
cantoBassanoIVincipitVoice = <<
    \new MensuralVoice <<
        { s1 \noBreak }
        \cantoBassanoIVincipit
    >>
>>
