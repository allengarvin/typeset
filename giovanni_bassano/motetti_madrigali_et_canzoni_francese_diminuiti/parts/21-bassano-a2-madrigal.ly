cantoBassanoXXIincipit = \relative c'' {
    \time 2/2
    \clef "petrucci-c1"
    \key c \major
...
cantoBassanoLyricsXXI = \lyricmode {
    An -- cor __ che col __ par -- ti -- re
    \ijLyrics
    Io __ mi __ sen -- to __ mo -- ri -- re,
...
cantoRoreXXIincipit = \relative c'' {
    \time 2/2
    \clef "petrucci-c1"
    \key c \major
...
cantoBassanoXXIincipitVoice = <<
    \new MensuralVoice <<
        { s1 \noBreak }
        \cantoBassanoXXIincipit
    >>
>>
