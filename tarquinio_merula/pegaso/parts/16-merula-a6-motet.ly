...
violinoOneXVI = \relative c''' {
    ...
    e4 c c c b2 | c1 r2 r1 r2 | R\breve. | 
        r4 g'8[ g] a4 a g2 g4 e8[ e] f4 e d2 | e a1 g\longa*3/4
    \bar "|."
}
...
violinoTwoXVI = \relative c'' {
    ...
    c4 a a a g2 | e1 r2 r1 r2 | R\breve. | 
        r4 e'8[ e] f4 e d2 e4 g8[ g] a4 a g2 | g f1 e\longa*3/4
    \bar "|."
}
...
cantoOneXVI = \relative c'' {
    ...
    c4 g8[ g] f4 c g'2 g4 c8[ c] c4 c b2 | c c1 c\longa*3/4
    \bar "|."
}
...
cantoTwoXVI = \relative c'' {
    ...
    c4 g8[ g] f4 c g'2 | g f1 g\longa*3/4
    \bar "|."
}
...
bassoXVI = \relative c' {
    ...
    a4 a,8[ a] f4 f g2 | c4 c8[ c] f,4 f g2 c4 c8[ c] f,4 f g2 | 
        c f,1 c'\longa*3/4
    \bar "|."
}
