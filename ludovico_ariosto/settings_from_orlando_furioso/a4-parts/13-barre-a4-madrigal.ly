cantoI = \relative c'' {
    ...
    bf1 | a\breve | r1 c2. c4 | d2 f4 f e c c d | c2 a. g4 bf( a8[ g]) |
...
bassoI = \relative c {
    ...
    f2 c r f | bf g f f ~ | f g a bf4 bf | a2 g r1 | r2 f bf a |
        g1 f | R\breve | f1. g2 | a f c'1 | f, r2 f | d2. d4 g2 g |

    c,4 c' a2. a4 | d2 d c1 | f, bf2 f | g1 d | r2 d f1 ~ | f2 d c c |
        bf bf bf4( c d e | f2) f c1 | f r2 f | d1. d2 | c c 

    bf2 bf | bf4( c d e f2) f | a1 f ~ | \invisibleTime \time 6/2
