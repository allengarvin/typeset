...
cantoXIX = \relative c' {
    ...
    d2 b4 d e d c b | a2 r4 d c b a g | a2. g8[ f] e4 g2 fs4 | g2 r4 g 

    e g a g | f e d e4. d8[ c b] a[ b c d] | 
        e[ f] g4. a8[ b c] d2 r4 d | b d 
...
tenoreXIX = \relative c' { 
    ...
    r2 g e4 g a g | f e d2 r4 g f e | d c d2. c8[ b] a2 | g1 r4 c a c |
    ...
    r4 g f e d c d2. c8[ b] a2 | \invisibleTime \time 4/2
        g\longa*1/2
    \bar "|."
}
