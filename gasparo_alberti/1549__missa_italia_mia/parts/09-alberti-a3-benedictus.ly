...
cantusIX = \relative c' {
    ...
    f\breve | f1 f | g\breve | a1 r2 g | g g a c ~ |
        c4\melfi b8[ a] b!2\melfiEnd c1 ~ | c r1 | R\breve | g1 c ~ |
        c2 bf a g | \colorBr f1.\colorBrBegin ( f8[ e d c] \colorBrEnd |
        d1) c | r2 f g f | g a bf1 | 

    a2 g2. f4 f2 ~ | f4( e8[ d] e2) f1 ~ | f\breve | R\breve*3 | r2 c'1 a2 |
...
altusIX = \relative c' {
    ...
    c\breve | d2 c d f ~ | f e4 d e2 c ~ | c bf4 a bf2 d |
        e c e f | g2. f4 e2 f ~ | f4 e d c d c bf a | g2

    c2.\melfi b4 b! a8[ b!]\melfiEnd | c2. d4 e1 | d1. e2 | a, d1 c2 ~ |
    ...
    a2 a | d2. c4 bf a g2 | c4 bf a g f2 c' ~ | c bf4 a g2 a ~ |
        a4 g c1\ficta b2\unficta | c a g1 | f2 f' e f ~ |
...
tenorIX = \relative c {
    ...
    g2 bf ~ | bf a g1 | f2 e d1 | c f ~ | f bf | a g ~ | g f2 c' ~ |
        c a a c | c c f,1 | r2 g bf bf | c1 r2 f, | f f g1 | r2 c, g' e |
        \colorBr f4.\colorBrBegin a8 a2\colorBrEnd g2 g | c c4

    c4 a2 a | g1 r2 c, | f f d1 | a' g | c r1 | f, bf ~ | bf2 a g1 |
        f r2 d | e c f f | d g2. f4 e d | c2 d a'1 | g2. f4 e2 f ~ |
        f4 e d c d1 | c2 c'1\melfi
