...
cantusI = \relative c' {
    ...
    d4 c | d1) c | r1 r2 d | e( c d e) | f f e( a ~ | a4 g8[ f] g2) a1 |
        R\breve | r1 r2 d | c a2.( bf4 c2) | d1 c | R\breve*2 R\breve |
        r2 f, f2.( g4 | a2) f bf1 | a r1 | R\breve | r1 r2 f |
        f2.( g4 a2) f | bf1 a | r2 g

    % --- page ---
    c4( a bf2 | c) d r1 | r1 r2 g, | a g a bf | c\breve | R | r1 g |
        f2 f e c' | a bf g( a ~ | a4 g f1 e2) | f\breve | R\breve R |
        r1 g | f2 f e c' | a bf g( a2 ~ | a4 g f1 e2) | f\breve~f~f\longa*1/2
    \bar "|."
}
...
altusI = \relative c {
   ...
   % checked thru here
    ...
    % checked thru here
        ...
        c1 d2 bf | d d c f | e f g1 | f r1 | 
        d2.\melfi c4 bf c2\melfi b4\melfiEnd |
        c1.( d2) | bf1 r1 | r2 d e f | d e2.\melfi c4 d2 ~ | d4 c

    c1 b2\melfiEnd | c2.( bf8[ c] d2) bf ~ | bf( a4 g) a1 | g r1 | 
    ...
    g f1) c'2 | d1 d2 e | c\melfi d2. c4 c2 ~ | c b\melfiEnd c c |
        a( bf) g a | f( f') e e | d1 c2.( bf4 | a1) r2 a | bf c bf1 |
        a\longa*1/2
    \bar "|."
}
...
tenorI = \relative c {
   ...
   % checked thru here
     ...
     \bar "||"
     % checked thru here
    R\breve R | c1 d2 bf | d d( c2. bf4 | a2 bf2. a4 g f | g1) f |
        r1 g | a2( f) a a | g2.( f4 e2 f ~ | f4 e d c d1) | c 

    r1 | r1 r2 c' ~ | c c a2.( g4 | f2) c'1\melfi b2\melfiEnd | c a c c |
        bf bf a a | g( f4 e d1) | c2 f f\melfi e |
        d2 d'2. cs8[ b] cs!2\melfiEnd | d2 d, e( c) | d e

    f2 f | e a2.( g8[ f] g2) | a2.( bf4 c1) | r1 r2 a | bf( g a bf) | 
        c c bf1 ~ | bf( a) | f2.( e4 d2) d | f1 d2 d | f2.( g4 a2 f | 
        bf1 a2) d, | 
    
    g1 f2.( g4 | a2) bf a bf ~ | bf4\melfi a g1 fs2\melfiEnd |
        g1 r2 bf | a( g a) bf | c c1\melfi b2\melfiEnd | c2.( bf4 a2) d | 
        c1. a2 | g a bf1 | c2 d g, c ~ | c( bf4 a)

    g2 a ~ | a4( d, d'2 c2. bf4 | a2 bf g1) | f c' | bf2 bf a c | 
        a bf g a ~ | a4( g) f1( e2) | f1 r2 a ~ | a d c2.( bf4) | a2( bf g1) | 
        f\breve~f~\longa*1/2
    \bar "|."
}
...
% bassus: checked against source completely!
bassusI = \relative c, {
    \key f \major
    \fourTwoCutTime
   ...
   % checked thru here
     ...
     bf2 c) g1 | r2 c d2.( c4 | bf2) a g( f) | g1 r1 | R\breve R | r1 g |
    ...
    R\breve
    R\breve*2 | r1 c | d2( bf) d d | c2.( bf4 a2 bf ~ | bf4 a g f g1) | 
    ...
    bf | f2.( g4 a2 a | bf1) a | R\breve | r1 r2 g | bf2.( c4 d2. c8[ bf]) |
        ...
        \ficta ef1\melisma d ~ | d\breve | g,1\melismaEnd\unficta d' | r2 g, a(

    g2) | a bf c( bf | a1) g | R\breve | r2 c f f | c1 bf2 bf | a d( c1) |
        f,2 bf c( a) | d bf c( a | d2. bf4 c1) | f, r2 f | bf2.( c4 d2)

    c2 | f, bf c c | d1( c) | f,2 bf c( a) | d bf c a | d2.( bf4 c1) |
        f, r2 f | bf a bf1 | f\longa*1/2
    \bar "|."
}
