...
cantoII = \relative c'' {
    ...
    a2 fs | g4 g e2 r2 g | a a c1 | c\breve | r2 r4 g b b d2 ~ |
        d r4 a cs cs e2 ~ | e1 r4 e, g g | a2 e f2 e r2 | r1 r2 b' |
        c a bf4 b gs2 |
    ...
    e4 e c'2 b a4 a | gs2 a b e, ~ | e1 r1 | r1 r2 a | a2. a4 c2 c a1
        gs\longa*1/2
    \bar "|."
}
...
tenoreII = \relative c {
    ...
    e2 a1 gs2 | gs1 a2 r2 | r1 r2 b ~ | b4 b b2 a2. d4 | c a b c a2 a |
    ...
    a2 fs g4 g e2 | d r4 g g2 a | fs4 fs gs2 a cs ~ | cs4 cs d2 b4 b a2 |
...
bassoII = \relative c {
    ...
    r1 r4 e c c | a a d2 c4 c 'g g | a e f2 e1 | r1 r2 e | f d e4 e cs2 |
...
quintoII = \relative c {
    ...
    gs4 a2 gs4 a1 ~ | a r2 b ~ | b4 b e,2 a2. d,4 | a' a g e f2 e4 e' ~ |
        e e e2 c2. f4 | f d e e d2 cs | r1 d2 d4 a | c2 g1 r2  
    ...
    b2 e, | a d g,4 g b2 | a1 r2 r4 e' | f2 d e4 e cs2 | d1 r1 | R\breve |
