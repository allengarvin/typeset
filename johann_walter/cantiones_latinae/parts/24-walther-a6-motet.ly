...
cantusXXIV = \relative c' {
    ...
    d4 c bf2) | a1 r2 a ~ | a( f g4 f e d | e2 c g'2. a4 | bf2 c1 bf2 |
        c2. bf4 a2 f) | g\breve | r2 g g2.( a4 | bf2 g) c2.( bf4 | a2 f)
    ...
    a2 f | bf4 a g f) e2.( d8[ e]) | f\longa*1/2
...
altusXXIV = \relative c {
    ...
    R\breve*2 | f1 \[ a( | bf) \] c | r2 c d( f ~ | f4 e d2) c g' ~ |
        g4( f e2 d c ~ | c bf c2. d4 | e2 f d1) | c r2 f( | e c 
