BIcantoPrimo = \relative c'' { 
    ...
    \repeat "volta" 2 {
        ...
        d8[ f g e] f[ e d c] | bf4. c16[ d] ef4 d | c bf a2 | g g |
    }
    \repeat "volta" 2 {
        d'4 g f e | d4. e8 f4 d ~ | d f e d |
        c4. d16[ e] f4 e | d4. e16[ f] g4 f | e4. f16[ g] a4 g | 
            f8[ d e f] g4 f | e f2 e4 | f4. e16[ d] c4 f |
        e d2 cs4 | d4. e8 f4 e | d2 c | b4 d c a | bf8[ c] d4 c bf | a c bf a|
            g8[ a] bf4 a g|
        f8[ g a bf] c4 f8[ e] | d[ c bf c] d[ c d e] | fs4 g2 fs4 | g2 g |
    }
}

BIcantoSecondo = \relative c'' { 
    \clef treble
    \key f \major
    \time 2/2
    \repeat "volta" 2 {
