...
cantoPrimoXXXIIincipit = \relative c'' { 
    \clef "petrucci-g"
    \key c \major
    \singleTime \time 3/2
...
cantoSecondoXXXIIincipit = \relative c'' { 
    \clef "petrucci-g"
    \key c \major
    \singleTime \time 3/2
...
cantoPrimoXXXIIincipitVoice = <<
    \new MensuralVoice <<
        { s1 \noBreak }
        \cantoPrimoXXXIIincipit
    >>
>>

cantoSecondoXXXIIincipitVoice = <<
    \new MensuralVoice <<
        { s1 \noBreak }
        \cantoSecondoXXXIIincipit
    >>
>>
