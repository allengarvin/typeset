...
cantoPrimoXXIXincipit = \relative c'' { 
    \clef "petrucci-g"
    \key f \major
    \singleTime \time 3/2
...
cantoSecondoXXIXincipit = \relative c'' { 
    \clef "petrucci-c1"
    \key f \major
    \singleTime \time 3/2
...
cantoPrimoXXIXincipitVoice = <<
    \new MensuralVoice <<
        { s1 \noBreak }
        \cantoPrimoXXIXincipit
    >>
>>

cantoSecondoXXIXincipitVoice = <<
    \new MensuralVoice <<
        { s1 \noBreak }
        \cantoSecondoXXIXincipit
    >>
>>
