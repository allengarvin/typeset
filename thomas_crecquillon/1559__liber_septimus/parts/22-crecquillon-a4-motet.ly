...
superiusXXII = \relative c' {
    ...
    g2 bf2. a4 g2 ~ | g \ficta f\unficta g1 | R\breve | r2 f bf2. bf4 |
    ...
    d2 bf'2. a4 g2 | f g1 f2 | d4 e f d e2 f ~ | f e f1 | r1 a ~ | a g ~ |
        g2 g f1 ~ | f bf ~ | bf a ~ | a2 g4 f g1 | a2 a1 a2 | f a1 g2 ~ | 
        g \ficta f\unficta g1 | R\breve | f1 g | bf2. bf4 bf2 bf | f bf

    a2 g ~ | g\ficta f\unficta g1 | R\breve | f1 a | bf1. a2 | bf bf a1 ~|
...
tenorXXII = \relative c {
    ...
    R\breve*4 | r1 f ~ |  f g1 ~ | g2 g a1 ~ | a2 a bf( a | c bf1 a4 g) |
        ...
        d4\melisma\ficta c b a b!1 | c1. c2 | d\breve\unficta\melismaEnd |
        c\fermata
    ...
    bf2. bf4 | bf2 bf a1 | a2 bf2. a4 g f | g2 g f f | bf2. bf4 bf2 bf |
        ...
        \[ a1 f g\breve \] | f1 r1 | bf1. bf2 | a g a2. g4 | f2 d'1 d2 | c bf
    ...
    g1 r1 | R\breve | r1 r2 g | bf1 c | bf a2 f | g2. f4 d2 d' ~ | d c4 bf c1 |
        r2 a bf1 | bf2. a4 g2 bf | a g f4 d g2 ~ | g\ficta fs\unficta g1 |
...
bassusXXII = \relative c {
    ...
    r2 g, ~ | g4 a bf c d ef f2 ~ | f\ficta e4 d e!1\unficta | f1 r1 |
    ...
    d2. c4 | bf2 d c bf | c1 bf | f'\breve | d1 ef ~ | ef bf | bf'\breve |
        ...
        r1 r2 bf | d1 ef ~ | ef2 d ef f | bf,4 c d ef f g a2 ~ | 
        a g1 \ficta f2\unficta |  

    g1 f ~ | f r2 d | ef1 ef2. d4 | c2 ef d c | d1 g, | R\breve*2 |
