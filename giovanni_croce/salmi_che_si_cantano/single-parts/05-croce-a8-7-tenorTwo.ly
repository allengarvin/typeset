...
\header {
    ...
    instrument = "Benedictus Dominus Deus Israel: The Canticle of Zechariah (tenor II)"
...
\book {
    ...
    \bookOutputSuffix "--7-tenorTwo--tr8_clef"
    \include "../include/paper-1-part.ly"
    \score {
        \new Voice << 
            \clef "treble_8"
...
\book {
    \bookOutputName "05-croce--benedictus_deus_israel-the_canticle_of_zechariah"
    \bookOutputSuffix "--7-tenorTwo--al_clef"
    \include "../include/paper-1-part.ly"
    \score {
        \new Voice << 
            \clef "alto"
