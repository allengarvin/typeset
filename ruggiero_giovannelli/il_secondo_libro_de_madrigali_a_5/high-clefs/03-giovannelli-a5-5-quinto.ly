...
% Invocation: /usr/local/bin/generate-single.py -t "Se di farmi morire" -p madrigal -l italian -v -m 80 03-giovannelli-a5-0-score.ly --subsubtitle "transposed down" canto:t alto:8a quinto:8a tenore:8a basso:b
...
\header {
    ...
    instrument = "Se di farmi morire:  (quinto)"
