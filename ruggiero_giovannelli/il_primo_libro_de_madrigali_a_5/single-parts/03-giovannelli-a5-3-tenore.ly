...
% Invocation: /usr/local/bin/generate-single.py -t "Se da' tuoi lacci sciolto" -l italian -p madrigal -m 86 -v 03-giovannelli-a5-0-score.ly canto:t alto:t quinto:ta8 tenore:ta8 basso:b
...
\header {
    ...
    subtitle = ""
    subsubtitle = ""
    instrument = "Se da' tuoi lacci sciolto:  (tenore)"
