...
\header {
    ...
    instrument = "Tous les regrets (altus)"
...
\book {
    ...
    \bookOutputSuffix "--tranposed_4th-2-altus--tr_clef"
    \include "../include/paper-1-part.ly"
    \score {
        \new Voice << 
            \clef "treble"
...
\book {
    \bookOutputName "22-tous_les_regrets"
    \bookOutputSuffix "--tranposed_4th-2-altus--tr8_clef"
    \include "../include/paper-1-part.ly"
    \score {
        \new Voice << 
            \clef "treble_8"
...
\book {
    \bookOutputName "22-tous_les_regrets"
    \bookOutputSuffix "--tranposed_4th-2-altus--al_clef"
    \include "../include/paper-1-part.ly"
    \score {
        \new Voice << 
            \clef alto
