...
cantusXVI = \relative c'' {
    ...
    g1 g | g g | g2( c,) e1 | d d | r2 g1 \ficta fs2\unficta |
        ...
        a2 c1 b2 | 
        c1 c 
    g'1 g | g g | g2( c,) e1 | d d | r2 g1 \ficta fs2\unficta |
        g4( f) e( d) c( b a g) | 
        a2 c1 b2 | 
        c1 c 
    ...
    g'1 g | g g | g2( c,) e1 | d1 d | r2 g1\ficta fs2\unficta | 
        g4( f) e( d) c( b a g) |
        a2( c1 b2) | c1 c2 e ~ | e4( f g1 e2 | f g e f) | d\breve | b1 r2 c ~|
        c( b4 a b2 c) | c\breve | 
    }
    \alternative { { c\breve } { c\breve } } 
        e1 e | e\breve | d | d1 d( | 
...
cantusLyricsXVI = \lyricmode {
    O -- sti -- na -- to vo' __ se -- gui -- re
    La ma -- gna -- ni -- ma __ mia~im _ - pre -- sa.
    O -- sti -- na -- to vo' __ se -- gui -- re
    La ma -- gna -- ni -- ma __ mia~im _ - pre -- sa.
    ...
    La ma -- gna -- ni -- ma __ 
        \ijLyrics
            ...
            im -- pre -- sa.
    -sa.
    La ma -- gna -- ni -- ma mia~im -- pre -- sa. __
%    O -- sti -- na -- to vo' se -- gui -- re,
%        se -- gui -- re. __
        \normalLyrics
}

cantusLyricsXVIa = \lyricmode {
    Fa -- me, Ciel, fa -- me, __ For -- tu -- na,
                        % vvvvvvvv como to come? or is that dialect
    Be -- ne~o mal __ _ _ co -- me~a te pia -- ce:
    Né pia -- cer né~in -- giu -- ria~al -- cu -- na
    Per av -- vi -- lir -- mi~o __ far __ _ più~au -- da -- ce:
    Che de l'un __ non son __ ca -- pa -- ce,
    L'al -- tro più __ non __ po' fug -- gi -- re.
}
...
cantusLyricsXVIb = \lyricmode {
    Vin -- ca~o per -- da~io non __ l'at -- ten -- do
    De mia~im -- pre -- sa~al - --  - tro che~o -- no -- re:
    So -- pra~il ciel be -- a -- to~a -- scen -- do
    S'io ne re -- sto __ _ vin - ci -- to -- re;
    S'io la per -- do~al fin __ gran co -- re
    Mo -- stra -- rà __ l'al -- to de -- si -- re.
}
%
...
altusXVI = \relative c' {
    ...
    r2 c'2. d4 e2 ~ | e d4 c c2 e | d4 c b a g1 ~ | g g | e' d2. c4 |
        b2 c1 c2 ~ | c4 b a2 g1 | e e | 
    ...
    \alternative { { e\breve } { e\breve } }
        g\breve | g | g1. \ficta b2\unficta | 
...
tenorXVI = \relative c' {
    ...
    \ficta b g1 fs2 | \unficta g1 c, | d2. c4 d1 | c\breve | 
    }
    \alternative { { c\breve } { c\breve } } 
...
bassusXVI = \relative c {
    ...
    c,1 c | c c | g2 a c1 | g g | c d | g,2 c1. | f,1 g | g' g | 
    ...
    \alternative { { g\breve } { g\breve } }
    c,1 c | c\breve | g | d'1 d |
