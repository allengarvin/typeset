...
\header {
    ...
    cksum = "8e714b74da855c074926f66be9162de851fb3622"
    % Things that change per piece:
    title = "Missa Salvum me fac"
    subtitle = "Gloria"
    instrument = "Missa Salvum me fac: Gloria (score)"
    ...
    \markup {
        \fill-line {
            \column {
                ...
                \line { \vspace #0.5 }
                \line { \italic { Domine Deus, Agnus Dei, Filius Patris. } }
            ...
            \column {
                ...
                \line { \vspace #0.5 }
                \line { \italic { O Lord God, Lamb of God, Son of the Father, } }
