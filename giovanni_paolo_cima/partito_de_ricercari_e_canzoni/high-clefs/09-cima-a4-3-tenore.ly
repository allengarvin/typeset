...
% Invocation: /usr/local/bin/generate-single.py -t "Canzon II 'La valeria'" -m 68 -l instrumental 09-cima-a4-0-score.ly --subsubtitle "transposed down" canto:t alto:8a tenore:8a basso:b
...
\header {
    ...
    instrument = "Canzon II 'La valeria':  (tenore)"
